...
class Remitas extends Model
{
    ...
    public function verifyRRR()
    {
        ...
        // $merchantId = 2547916;
        $apiKey = 154279;
        $merchantId = 8434377560;
        $hash = hash('sha512', $this->rrr . $apiKey . $merchantId);
          $url = "https://login.remita.net/remita/exapp/api/v1/send/api/echannelsvc/". $merchantId . "/" . $this->rrr . "/" . $hash . "/status.reg";
