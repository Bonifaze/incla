            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                ...
                <li class="nav-item has-treeview <?php echo $__env->yieldContent('bursary-open'); ?>">
                    ...
                    <ul class="nav nav-treeview ml-4">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo e(route('bursary.search')); ?>" class="nav-link <?php echo $__env->yieldContent('bursary-search'); ?>">
                                <i class="fas fa-search nav-icon"></i>
                                <p>Search Student</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="#" class="nav-link <?php echo $__env->yieldContent('bursary-search'); ?>">
                                <i class="fas fa-search nav-icon"></i>
                                <p>Search Applicant</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="/bursary/remita/fee-typesrrr" class="nav-link <?php echo $__env->yieldContent('bursary-search'); ?>">
                                <i class="fa fa-eye nav-icon"></i>
                        ...
                        <li class="nav-item has-treeview <?php echo $__env->yieldContent('exam-officers-open'); ?>">
                            <a href="#" class="nav-link <?php echo $__env->yieldContent('bursary-applcant'); ?>">
...
<?php /**PATH C:\Users\Lawrence Chris\Desktop\laraproject\resources\views/partialsv3/sidebar.blade.php ENDPATH**/ ?>