        ...
        <div class="inner">
            <form method="POST" action="/register">
                ...
                <div class="form-group">
                    <div class="form-wrapper  <?php $__errorArgs = ['surname'];
...
unset($__errorArgs, $__bag); ?>" id="surname" type="text" class="form-control <?php $__errorArgs = ['surname'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-wrapper">
                    ...
                    <select id="admission_type" name="admission_type" class="form-control <?php $__errorArgs = ['admission_type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
