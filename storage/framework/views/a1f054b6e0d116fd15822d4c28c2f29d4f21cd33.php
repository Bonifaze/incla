...
<title><?php echo e($session->semesterName($semester)); ?> <?php echo e($session->name); ?> Course Form</title>
...
<table width="650" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="650" valign="top"><table width="100%" height="174" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td align="center" valign="top"><h1><strong><?php echo e($session->semesterName($semester)); ?> <?php echo e($session->name); ?> Course Form </strong></h1></td>
      </tr>
    </table>
      <table width="100%" border="0">
        ...
        <table width="100%" height="87" border="1" cellpadding="0" cellspacing="0">
                          <tr>
                            ...
                            <td colspan="1" align="center"><strong>LEVEL</strong>: <?php echo e($registration->level); ?> </td>
                            <td colspan="1"><strong>SEMESTER</strong>: <?php echo e($session->semesterName($semester)); ?></td>
                          </tr>
                          <tr>
						 ...
						 <tr>
                            ...
                            <td width="50%"><div align="center"><span style="font-weight: bold"><?php echo e($result->programCourse->course->title); ?> </span></div></td>
                            <td width="10%"><div align="center"><span style="font-weight: bold"><?php echo e($result->programCourse->hours); ?> </span></div></td>
                         ...
                         <tr>
                            ...
                            <td width="10%"><div align="center"><span style="font-weight: bold"><?php echo e($total); ?> </span></div></td>
                            <td width="20%"><div align="center"><span style="font-weight: bold"> </span></div></td>
                          </tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.plain', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Lawrence Chris\Desktop\laraproject\resources\views/results/course_form.blade.php ENDPATH**/ ?>