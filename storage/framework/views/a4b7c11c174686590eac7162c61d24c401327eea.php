            ...
            <div class="card-body p-5">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link<?php echo e($transfers->status == 0 ? ' active' : ''); ?> text-success fw-bold text-capitalize" id="home-tab" type="button" role="tab" aria-controls="home-tab-pane" aria-selected="<?php echo e($transfers->status  == 0 ? 'true' : 'false'); ?>">Biodata</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link<?php echo e($transfers->status  == 1 ? ' active' : ''); ?> text-success fw-bold text-capitalize" id="profile-tab" type="button" role="tab" aria-controls="profile-tab-pane" aria-selected="<?php echo e($transfers->status  == 1 ? 'true' : 'false'); ?>">Sponsor Information</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link<?php echo e($transfers->status  == 2 ? ' active' : ''); ?> text-success fw-bold text-capitalize" id="profile2-tab" type="button" role="tab" aria-controls="profile2-tab-pane" aria-selected="<?php echo e($transfers->status  == 2 ? 'true' : 'false'); ?>">Trasnfer Information</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link<?php echo e($transfers->status  == 3 ? ' active' : ''); ?> text-success fw-bold text-capitalize" id="profile3-tab" type="button" role="tab" aria-controls="profile3-tab-pane" aria-selected="<?php echo e($transfers->status  == 3 ? 'true' : 'false'); ?>">Upload Documents</button>
                    </li>
                </ul>
...
unset($__errorArgs, $__bag); ?>" name="surname" placeholder="<?php echo e($transfers->surname); ?>" readonly autofocus>
                ...
                <div class="tab-pane fade<?php echo e($transfers->status == 1 ? ' show active' : ''); ?>" id="profile-tab-pane" role="tabpanel" aria-labelledby="profile-tab">
                    <form method="POST" action="/transferssponsors" enctype="multipart/form-data" class="p-3">
                        ...
                        <div class="form-group">
                                <div class="form-group">
                                    <label for=""><?php echo e(__('Tile')); ?> </label>
                ...
                <div class="tab-pane fade<?php echo e($transfers->status == 2 ? ' show active' : ''); ?>" id="profile2-tab-pane" role="tabpanel" aria-labelledby="profile2-tab">
                    <form method="POST" action="/transfersinformation" class="p-3">
                        <?php echo csrf_field(); ?>
                        <!-- <label for="refferal" class="h4 mt-3 mb-3"><?php echo e(__('Previous University Information:')); ?> </label> -->
                        <div class="form-group">
...
<?php echo $__env->make('layouts.adminsials', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/lifeofrence/Documents/laraproject/resources/views/admissions//transfers.blade.php ENDPATH**/ ?>