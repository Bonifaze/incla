            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    <li class="nav-item has-treeview <?php echo $__env->yieldContent('fees-open'); ?>">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="/students/remita/paymentview/{id}" class="nav-link <?php echo $__env->yieldContent('viewremita'); ?>">
                                    <i class="fa fa-eye nav-icon"></i>
                                    <p>View Remita</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="/students/remita/feestype" class="nav-link <?php echo $__env->yieldContent('remita'); ?>">
...
<?php /**PATH C:\Users\abdul\OneDrive\Documents\workspace\laravel\laraproject\resources\views/spartials/sidebar.blade.php ENDPATH**/ ?>