...
<html>
<head>
   <?php $__currentLoopData = $utmeadmission; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $utm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <title><?php echo e($utm->first_name." ".$utm->middle_name." ".$utm->surname); ?>   Veritas Univeristy Abuja Admisssion Letter </title>
...
body {
  ...
  text-justify: inter-word;
   ...
   .background-image {
        ...
        width: 100%;
        padding-left: 100px;
        background-image: url('<?php echo e(asset('img/letter_logo.png')); ?>');
...
<p>Following your application through Unified Tertiary Matriculation Examination (UTME) conducted by the Joint Admissions and Matriculation Board (JAMB) for the 2023/2024 academic session, I write to offer you a Provisional Admission into the
...
<p>If you accept the  offer, please Login into your Admission portal to pay a <u  style="color:red">NON-REFUNDABLE</u> acceptance fee of Sixty Thousand Naira (₦80,000:00). The acceptance fee is NOT part of the  tuition fee.</p>
...
<p align='left'> <img src="<?php echo e(asset('img/register.png')); ?>" width='100' height='60' border='0' /></p>
...
<?php /**PATH /Users/lifeofrence/Documents/laraproject/resources/views/admissions/utmeletter.blade.php ENDPATH**/ ?>