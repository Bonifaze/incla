<aside class="sidebar">
    ...
    <a href="<?php echo e(route('student.home')); ?>"
        ...
        <img src="<?php echo e(asset('img/logs.png')); ?>"" alt="Logo">
            ...
            <ul class="sidebar-menu">
                <li class="sidebar-menu__item has-dropdown">
                    <a href="/home" class="sidebar-menu__link">
                        ...
                        <span class="text">Dashbord Home</span>
                    </a>
                ...
                <li class="sidebar-menu__item has-dropdown">
                    ...
                    <ul class="sidebar-submenu">
                        <li class="sidebar-submenu__item">
                            ...
                            <a href="student-courses.html" class="sidebar-submenu__link">  View Profile </a>
                               ':''; ?>

                        </li>
                        <li class="sidebar-submenu__item">
                            <a href="£" class="sidebar-submenu__link"> Edit Profile</a>
                        </li>
                        <li class="sidebar-submenu__item">
                            <a href="/editpassword" class="sidebar-submenu__link"> Change Password </a>
                        </li>
                    </ul>
                    <!-- Submenu End -->
                </li>
                ...
                <li class="sidebar-menu__item">
                    <a href="assignment.html" class="sidebar-menu__link">
                        ...
                        <span class="text">View Payment</span>
                    </a>
                </li>
                <li class="sidebar-menu__item">
...
</aside><?php /**PATH C:\Users\CLINTON\Downloads\incla\resources\views/adminsials/sidebar1.blade.php ENDPATH**/ ?>