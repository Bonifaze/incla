        ...
        <div class="container-fluid">
            ...
            <form action="" method="POST" onsubmit="event.preventDefault();" class="p-5">
                ...
                <div class="form-group container-fluid mt-5 p-5 border border-success shadow shadow-lg rounded rounded-lg">
                    <label for="exampleFormControlSelect1" class="text-success fw-bold mb-2">Acceptance Type</label>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.adminsials', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/lifeofrence/Documents/laraproject/resources/views/admissions/acceptancepayment.blade.php ENDPATH**/ ?>