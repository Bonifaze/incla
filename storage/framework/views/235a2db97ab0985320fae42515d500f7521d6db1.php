                            ...
                            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                ...
                                <div class="dropdown no-arrow">
                                    <h3 class="card-title text-success">
                                        ...
                                        <?php if(isset($sum)): ?>
                                            <?php echo e('Total: ₦' . number_format($sum)); ?>
                                    ...
                                    <table class="table table-bordered table-striped" id="dataTable" width="100%"
                                        ...
                                        <?php $__currentLoopData = $remitas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $remita): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td><?php echo e($remita->student->fullname ?? ' '); ?></td>

                                                <td><?php echo e($remita->student->academic->mat_no ?? ' '); ?></td>
...
<?php echo $__env->make('layouts.mini', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Lawrence Chris\Desktop\laraproject\resources\views/admissions/bursary/remita_list.blade.php ENDPATH**/ ?>