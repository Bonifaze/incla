                                ...
                                <div
                                    ...
                                    <div class="form-floating mb-3 mt-3">
                                        <input type="hidden" class="form-control" id="js-firstName"
                                            ...
                                            value="<?php echo e(Auth::guard('student')->user()->full_name); ?>" name="firstName"
                                            readonly>
                                    ...
                                    <div class="form-floating mb-3 mt-3">
                                        <input type="hidden" class="form-control" id="js-email"
                                            placeholder="<?php echo e(Auth::guard('student')->user()->email); ?>"
                                            value="<?php echo e(Auth::guard('student')->user()->email); ?>" name="email" readonly>
                                        <label for="email"></label>
                                    </div>

                                    <div class="form-floating mb-3 mt-3">
                                        <input type="hidden" class="form-control" id="js-phone"
                                            placeholder="<?php echo e(Auth::guard('student')->user()->phone); ?>"
                                            value="<?php echo e(Auth::guard('student')->user()->phone); ?>" name="email" readonly>
                                        <label for="email"></label>
                                    </div>
                                    <div class="form-floating mb-3 mt-3">
                                        <input type="hidden" class="form-control" id="js-id"
                                            placeholder="<?php echo e(Auth::guard('student')->user()->id); ?>"
                                            value="<?php echo e(Auth::guard('student')->user()->id); ?>" name="email" readonly>
                                        <label for="email"></label>
                                    </div>
...
<?php echo $__env->make('layouts.student', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/lifeofrence/Documents/laraproject/resources/views/students/RemitaPayment.blade.php ENDPATH**/ ?>