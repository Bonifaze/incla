                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-bordered table-striped" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                  <a href="data:image/png;base64,<?php echo e($allApp->passport); ?>"
                                                    data-toggle="lightbox" data-title="Passport">
                                                    <img src="data:image/png;base64,<?php echo e($allApp->passport); ?>"
                                                ...
                                                <td>
                                                    <a href="/adminView/<?php echo e($allApp->applicant_type); ?>/<?php echo e(urlencode(base64_encode($allApp->id))); ?>" class="btn btn-primary border mt-2"> View </a>
                                                </td>
...
<?php echo $__env->make('layouts.mini', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/lifeofrence/Downloads/inclaproject/incla/resources/views/admissions/allApplicants.blade.php ENDPATH**/ ?>