                ...
                <div class="card card-primary">
                    ...
                    <form method="POST" action="/students/store" enctype="multipart/form-data" class="p-3">
                        ...
                        <div class="position-relative mt-5 mb-5">
                            ...
                            <button type="submit" onclick="deleteCourse()" class="btn btn-success position-absolute bottom-0 end-0" data-bs-toggle="modal" data-bs-target="#myModal"><?php echo e(__('Generate Matric Number')); ?></button>
...
<?php echo $__env->make('layouts.userapp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Lawrence Chris\Desktop\laraproject\resources\views/admissions/students/admin/create.blade.php ENDPATH**/ ?>