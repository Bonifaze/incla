						...
						<table class="table table-striped">
						  ...
						  <?php $__currentLoopData = $pcourses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $pcourse): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							...
							<tr>
							 ...
							 <td><?php echo e($pcourse->credit_load); ?></td>
							 <td><?php echo e($pcourse->session->name); ?></td>
							 <td><?php echo e($pcourse->staff->FullName); ?></td>
							<td><a href="<?php echo e(route('program_course.edit',$pcourse->id)); ?>"> Edit </td>
...
<?php echo $__env->make('layouts.mini', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Lawrence Chris\Desktop\laraproject\resources\views//program-courses/list.blade.php ENDPATH**/ ?>