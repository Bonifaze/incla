            ...
            <div class="card-body p-5">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link<?php echo e($utme->status == 0 ? ' active' : ''); ?> text-success fw-bold text-capitalize" id="home-tab" data-bs-toggle="tab" data-bs-target="#home-tab-pane" type="button" role="tab" aria-controls="home-tab-pane" aria-selected="<?php echo e($utme->status  == 0 ? 'true' : 'false'); ?>">Bio Data</button>
                    </li>
                    <li class="nav-item" role="presentation">
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link<?php echo e($utme->status  == 2 ? ' active' : ''); ?> text-success fw-bold text-capitalize" id="profile2-tab" data-bs-toggle="tab" data-bs-target="#profile2-tab-pane" type="button" role="tab" aria-controls="profile2-tab-pane" aria-selected="<?php echo e($utme->status  == 2 ? 'true' : 'false'); ?>">Jamb</button>
                    </li>
                    <li class="nav-item" role="presentation">
...
unset($__errorArgs, $__bag); ?>" name="surname" placeholder="<?php echo e($utme->surname); ?>" readonly autofocus>
                    ...
                    <div class="tab-pane fade<?php echo e($utme->status == 1 ? ' show active' : ''); ?>" id="profile-tab-pane" role="tabpanel" aria-labelledby="profile-tab">
                        <!-- Content for Sponsor Information tab -->
                        <form method="POST" action="/utmesponsers" enctype="multipart/form-data" class="p-3">
                            <?php echo csrf_field(); ?>
                            <div class="form-group">
                                <div class="form-group">
                                    <label for=""><?php echo e(__('First Name')); ?> </label>
                    ...
                    <div class="tab-pane fade<?php echo e($utme->status == 2 ? ' show active' : ''); ?>" id="profile2-tab-pane" role="tabpanel" aria-labelledby="profile2-tab">
                        <!-- Content for Jamb tab -->
                        <form method="POST" action="/utmejamb" enctype="multipart/form-data" class="p-3">
                            <?php echo csrf_field(); ?>

                            <div class="form-group">
                                <div class="form-group">
                                    <label for=""><?php echo e(__('Jamb Registration number')); ?> </label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for=""><?php echo e(__('First Choice')); ?> </label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for=""><?php echo e(__('Second Choice')); ?> </label>
                            ...
                            <div class="form-group">
                                <div class="form-group">
                                    <label for=""><?php echo e(__('Jamb Subject 1')); ?> </label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for=""><?php echo e(__('Jamb Subject 2')); ?> </label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for=""><?php echo e(__('Jamb Subject 3')); ?> </label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for=""><?php echo e(__('Jamb Subject 4')); ?> </label>
                    ...
                    <div class="tab-pane fade<?php echo e($utme->status == 3 ? ' show active' : ''); ?>" id="profile3-tab-pane" role="tabpanel" aria-labelledby="profile3-tab">
                        <!-- Content for Upload Documents tab -->
                        <form method="POST" action="/utmeuploads" enctype="multipart/form-data" class="p-3">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="passport"><?php echo e(__('Upload Other Olevel Result - If any(.jpeg, .png, .jpg)')); ?></label>
...
<script>
    $(document).ready(function() {
        ...
        var activeTab = $('#myTab .nav-link.active').attr('aria-controls');
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.adminsials', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\hp\Documents\WEB DEV\Work-VUNA\laraproject\resources\views/admissions//utme.blade.php ENDPATH**/ ?>