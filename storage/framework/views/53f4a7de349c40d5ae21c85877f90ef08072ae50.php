...
unset($__errorArgs, $__bag); ?>" name="surname" placeholder="<?php echo e($pg->surname); ?>" readonly autofocus>
                        ...
                        <form method="POST" action="/pginformation" class="p-3">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-select col-12 text-lg" name="mode">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                 <label for="refferal"><?php echo e(__('MODE OF LEARNING:')); ?> </label>
                                    <select class="form-select col-12 text-lg" name="type">
                            ...
                            <br>
                            <br>
                             <h3 class="app-page-title text-uppercase h5 font-weight-bold p-2 mb-2 shadow-sm text-center text-primary border">
 ...
 <label for="refferal"><?php echo e(__('Certificate Obtained:')); ?> </label>
                                <div class="form-group">
                                    <select class="form-select col-12 text-lg" name="certificate_type">
