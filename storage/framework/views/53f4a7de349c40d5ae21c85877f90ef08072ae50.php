        ...
        <div class="card mb-4">
            ...
            <div class="card-body p-5">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link<?php echo e($pg->status  == 2 ? ' active' : ''); ?> text-success fw-bold text-capitalize" id="profile2-tab" type="button" role="tab" aria-controls="profile2-tab-pane" aria-selected="<?php echo e($pg->status  == 2 ? 'true' : 'false'); ?>">PostGraduate Information</button>
                    </li>
                    <li class="nav-item" role="presentation">
...
unset($__errorArgs, $__bag); ?>" name="surname" placeholder="<?php echo e($pg->surname); ?>" readonly autofocus>
                    ...
                    <div class="tab-pane fade<?php echo e($pg->status == 2 ? ' show active' : ''); ?>" id="profile2-tab-pane" role="tabpanel" aria-labelledby="profile2-tab">
                        <form method="POST" action="/pginformation" class="p-3">
                            ...
                            <div class="form-group">
                                <label for="refferal"><?php echo e(__('Course Studied:')); ?> </label>
                                <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="refferal"><?php echo e(__('Certificate honor:')); ?> </label>
                                <div class="form-group">
                            ...
                            <label for="refferal"><?php echo e(__('First Refree:')); ?> </label>
                            <div class="form-group">
...
<?php echo $__env->make('layouts.adminsials', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/lifeofrence/Documents/laraproject/resources/views/admissions//pg.blade.php ENDPATH**/ ?>