...
<div class="content-wrapper">
    ...
    <tr>
        ...
        <td>
            <?php if($staffs->count()): ?>
                <?php $__currentLoopData = $staffs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php echo e($sc->staff->full_name ?? 'No Name'); ?><br>
        ...
        <td>
            <a href="<?php echo e(route('program_course.edit', $pcourse->id)); ?>" class="btn btn-warning">Edit</a>
        </td>
        <td>
            <?php echo Form::open(['method' => 'Delete', 'route' => 'program_course.delete', 'id' => 'deletePCourseForm'.$pcourse->id]); ?>
                ...
                <button onclick="deletePCourse(<?php echo e($pcourse->id); ?>)" type="button" class="btn btn-danger">
...
<?php echo $__env->make('layouts.mini', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/lifeofrence/Downloads/PROJECTCODE/inclaproject/incla/resources/views/program-courses/list.blade.php ENDPATH**/ ?>