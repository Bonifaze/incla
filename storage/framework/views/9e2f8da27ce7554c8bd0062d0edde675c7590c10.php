...
<script>
 ...
 var data = <?php echo json_encode($programModifications->map(function($item) {
    return [
        'course_name' => $item->course->name, 'result' => $item->ca2_score + $item->ca3_score + $item->ca1_score + $item->exam_score, // ... other data properties you want to include in the chart
    ];
})->toArray()) ?>;
...
<?php echo $__env->make('layouts.mini', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/lifeofrence/Documents/laraproject/resources/views/rbac/resultbarchatcourse.blade.php ENDPATH**/ ?>