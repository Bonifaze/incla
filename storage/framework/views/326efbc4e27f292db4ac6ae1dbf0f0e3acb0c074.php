...
.navbar-nav.right-navbar-links {
    margin-left: auto; /* Push the right navbar items to the right */
    display: flex;
    align-items: center;
    gap: 1rem; /* Adjust the spacing between the elements */
}
...
.dropdown-menu {
    left: auto !important; /* Ensure the dropdown is aligned to the right */
    right: 0 !important;   /* Align dropdown to the right */
}

.nav-item {
    margin-left: 16px; /* Add some space between the navbar items */
}
