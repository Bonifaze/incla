      ...
      <div class="container-fluid">
       ...
       <?php if( $session->status == 1): ?>
                             ...
                             <?php endif; ?>
								...
								<td><a class="btn btn-warning" href="<?php echo e(route('session.editBursary',$session->id)); ?>"> <i class="fa fa-edit"></i> Edit </td>

							<?php if($session->status == 1): ?>
									<td>Current Session</td>
								<?php elseif($session->status == 0): ?>
							 <td>
									<?php echo Form::open(['method' => 'Patch', 'route' => 'session.set_currentBursary', 'id'=>'setCurrentForm'.$session->id]); ?>
...
<?php echo $__env->make('layouts.mini', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/lifeofrence/Documents/laraproject/resources/views//sessions/listBursary.blade.php ENDPATH**/ ?>