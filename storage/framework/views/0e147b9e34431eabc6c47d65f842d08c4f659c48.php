            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-1 p-2 text-black-800 fw-bold text-capitalize">Postgradute Profile</h1> <br>
...
src="data:image/jpeg;base64,<?php echo e($applicantsDetails->olevel1); ?>"
                    ...
                    <div class="card-body d-sm-flex align-items-center justify-content-between">
                        <h5 class="card-title text-success">Refree Data</h5> <br>
                    ...
                    <div class="card-body d-sm-flex align-items-center justify-content-between">
                        <h5 class="card-title text-success mr-4">Sponsor Data</h5> <br>
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item">Phone Number: <b><?php echo e($applicantsDetails -> sponsors_phone); ?></b></li>
...
<?php echo $__env->make('layouts.userapp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/lifeofrence/Documents/laraproject/resources/views/admissions//viewPGprofile.blade.php ENDPATH**/ ?>