<?php $__env->startSection('pagetitle'); ?> Search Remita  <?php $__env->stopSection(); ?>
...
<div class="content-wrapper">
    ...
    <h1
            ...
            <div class="card card-olive">
                ...
                <div class="">
                    <!-- form start -->
                    <?php echo Form::open(array('route' => 'remita.find-date', 'method'=>'POST', 'class' => 'nobottommargin')); ?>
                                ...
                                <div class="bootstrap-timepicker col-md-6 " >
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date" id="start_date" data-target-input="nearest">
                                            <input type="text" name="start_date" placeholder="2022-01-01" class="form-control datetimepicker-input" data-target="#start_date"  required = 'required'/>
                                ...
                                <div class="bootstrap-timepicker col-md-6 " >
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date" id="end_date" data-target-input="nearest">
                                            <input type="text" name="end_date" placeholder="2023-01-01" class="form-control datetimepicker-input" data-target="#end_date" required = 'required'/>
            ...
            <div class="card card-success">
             ...
             <div class="table-responsive">
  			<!-- form start -->
						<?php echo Form::open(array('route' => 'remita.find-rrr', 'method'=>'POST', 'class' => 'nobottommargin')); ?>
			...
			<div class="card-body">
              <div class="box-body">
              			...
              			<div  <?php if($errors->has('data')): ?> class ='has-error form-group' <?php endif; ?>>
								...
								<?php echo Form::search('data', null, array( 'placeholder' => 'RRR','class' => 'form-control', 'id' => 'data', 'required' => 'required')); ?>
            ...
            <div class="card card-success">
                ...
                <div class="table-responsive">
                    <!-- form start -->
                    <?php echo Form::open(array('route' => 'remita.find-student', 'method'=>'POST', 'class' => 'nobottommargin')); ?>
