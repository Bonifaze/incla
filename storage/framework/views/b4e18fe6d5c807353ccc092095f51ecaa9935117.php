...
<h1 class="app-page-title text-uppercase h6 font-weight-bold p-3 mb-3 shadow-sm text-center text-white bg-success border rounded">
                    Welcome to InCLA All Approved <?php echo e($user_type); ?> Applicants List
                </h1>
                ...
                <div class="card-body ps-0" style="overflow-x: auto; white-space: nowrap; padding-bottom: 1rem;">
                    <div class="d-flex">
                        ...
                        <div class="col-lg-1 col-md-2 col-sm-3 col-4 text-center mb-3">
                            ...
                            <p class="mb-0 text-sm" ><?php echo e(ucwords(strtolower($allApp->surname))); ?> <?php echo e(ucwords(strtolower($allApp->first_name))); ?></p>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-bordered table-striped" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <td><?php echo e(ucwords(strtolower($allApp->surname))); ?> <?php echo e(ucwords(strtolower($allApp->first_name))); ?> <?php echo e(ucwords(strtolower($allApp->middle_name))); ?></td>
                                                ...
                                                <td><?php echo e($allApp->approval_date); ?></td>
...
<?php echo $__env->make('layouts.mini', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/lifeofrence/Downloads/inclaproject/incla/resources/views/admissions/allApprovedApplicants.blade.php ENDPATH**/ ?>