                ...
                <div class="col_full">
                    ...
                    <div class="card ">
                        ...
                        <div class="table-responsive">
                            <!-- form start -->
                            <?php echo Form::open(['route' => 'rbac.audit-find', 'method' => 'POST', 'class' => 'nobottommargin']); ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 form-group">
                                            <div <?php if($errors->has('data')): ?> class ='has-error form-group' <?php endif; ?>>
                                                <label for="data">staff Id/ Event/ Old Value/ New Value/ URL/ PC Model/
                                                    Audit ID :</label>
                            ...
                            <tbody>
                                ...
                                <?php $__currentLoopData = $article; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $audit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            <form action="<?php echo e(route('audit.destroy', $audit->id)); ?>" method="POST">
                                                <?php echo csrf_field(); ?>
                            ...
                            <?php $__currentLoopData = $logs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $audit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo e($audit->role->name); ?></td>
                                     <td>
                                            <form action="<?php echo e(route('audit.destroyR', $audit->id)); ?>" method="POST">
                                                <?php echo csrf_field(); ?>
                                                <?php echo method_field('DELETE'); ?>
                                                <button type="submit">Delete</button>
                                            </form>
...
<?php echo $__env->make('layouts.mini', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/lifeofrence/Documents/laraproject/resources/views//rbac/auditA.blade.php ENDPATH**/ ?>