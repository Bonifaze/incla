							...
							<tr>
                             ...
                             <td><?php echo e($program->name); ?></td>
							  <td> <?php echo e($program->registeredStudentsCount(1000)); ?> </td>
                                <td><a class="btn btn-outline-info" href="<?php echo e(route('academia.department.manage_program',base64_encode($program->id))); ?>">  View </a></td>
...
<?php echo $__env->make('layouts.mini', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\abdul\OneDrive\Documents\workspace\laravel\laraproject\resources\views/academia/departments/programs.blade.php ENDPATH**/ ?>