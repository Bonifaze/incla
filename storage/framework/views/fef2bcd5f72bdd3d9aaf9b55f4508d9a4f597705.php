        ...
        <div class="col_full">
           <h1
            ...
            <!-- form start -->
					...
					<?php echo Form::model($student, ['method' => 'PATCH','route' => ['student.update', $student->id], 'class' => 'nobottommargin', 'files' => true]); ?>
...
<?php echo $__env->make('layouts.mini', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/lifeofrence/Downloads/inclaproject/incla/resources/views/students/admin/edit.blade.php ENDPATH**/ ?>