            ...
            <div class="container-fluid">
                ...
                <div class="col_full">
                    <h1
                        ...
                        DIRECT ENTRY APPLICANT PROFILE
                    </h1>
                                                        ...
                                                        <div class="col-auto">
                                                            ...
                                                            <div class="rounded-circle">
                                                                <img class="rounded-circle p-3 mx-auto d-block"
                                                                    src="data:image/jpg;base64,<?php echo e($applicantsDetails->passport); ?>"
                                                                    //
                                                            ...
                                                            <div class="">
                                                                ...
                                                                <div class="">
                                                                    <ul class="list-group list-group-flush">
                                                                        ...
                                                                        <li class="list-group-item">Jamb DE NO.:
                                                                            <b><?php echo e($applicantsDetails->jamb_de_no); ?></b>
                                                                        </li>
                                                                        <li class="list-group-item">Qualification:
                                                                            <b><?php echo e($applicantsDetails->qualification); ?></b>
                                                                        </li>
                                                                        <li class="list-group-item">Year Qualification
                                                                            Obatained:
                                                                    ...
                                                                    <br>
                                                                    <form method="POST" action="/changecourseDE">
                                                                        <?php echo csrf_field(); ?>
                                                                        <?php if(session('approvalMsg')): ?>
                                                                            <?php echo session('approvalMsg'); ?>
                                                                        ...
                                                                        <div class="form-group">
                                                                            <div class="form-group">
                                                                                <input type="hidden"
                                                                                    value="<?php echo e($applicantsDetails->jamb_de_no); ?>"
                                                                                    name="jamb_de_no">
                                                                                <label
...
<?php echo $__env->make('layouts.mini', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/lifeofrence/Documents/laraproject/resources/views/admissions/layouts/viewDeApplicants.blade.php ENDPATH**/ ?>