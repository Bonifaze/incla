...
<head>
   <?php $__currentLoopData = $pgadmission; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $utm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <title><?php echo e($utm->first_name." ".$utm->middle_name." ".$utm->surname); ?> Institute of Consecrated Life in Africa (InCLA) Admisssion Letter </title>
...
<?php /**PATH /Users/lifeofrence/Downloads/inclaproject/incla/resources/views/admissions/letterPDF.blade.php ENDPATH**/ ?>