...
unset($__errorArgs, $__bag); ?>" placeholder="English, French etc ">
                                ...
                                <div class="form-group">
                                    <div class="form-row form-row-1">
                                        ...
                                        <input type="text" name="bld" id="bld" class="inpute-text <?php $__errorArgs = ['bld'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" placeholder="O+, O- " required>
                                    </div>


                                    <div class="form-row form-row-2">
                                        <label for="genotype">Genotype </label>
                                        <input type="text" name="genotype" id="genotype" class="input-text <?php $__errorArgs = ['genotype'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" placeholder="AA, AS " required>
                                    </div>
