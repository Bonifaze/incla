                            ...
                            <div class="form-left">
                                ...
                                <div class="form-group">
                                    <div class="form-row form-row-1">
                                        ...
                                        <input type="text" name="surname" id="" class="input-text" placeholder="<?php echo e(session('userssurname')); ?> " required readonly>
                                    </div>
                                    <div class="form-row form-row-2">
                                        <input type="text" name="first_name" id="first_name" class="input-text" placeholder="<?php echo e(session('usersFirstName')); ?>" required readonly>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="form-row form-row-1">
