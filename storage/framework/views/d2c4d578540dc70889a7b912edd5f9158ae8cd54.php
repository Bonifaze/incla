    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
            <a id="dropdownSubMenu1" style="color: #c95b28;" href="#" data-toggle="dropdown"
                aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle"><?php echo e(Auth::guard('student')->user()->full_name); ?></a>
            ...
            <div class="dropdown">
                <button class="users arrow-down-icon border border-gray-100 rounded-circle p-2 position-relative" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <span class="position-relative">
                        <img src="data:image/png;base64,<?php echo e(Auth::guard('student')->user()->passport); ?>" alt="User Image" class="h-10 w-20 rounded-circle" style="width: 20px;">
                    ...
                    <div class="card border-0 rounded-12 overflow-hidden box-shadow-custom" style="background: #e5e5e5; padding: 0;">
                        <div class="card-body py-4 px-3 text-center">
                            <div class="d-flex flex-column align-items-center mb-3">
                                <img src="data:image/png;base64,<?php echo e(Auth::guard('student')->user()->passport); ?>" alt="User Image" class="rounded-circle mb-2" style="width: 60px; height: 60px; object-fit: cover;">
                                <h5 class="mb-1 text-dark"><?php echo e(Auth::guard('student')->user()->full_name); ?></h5>
                                <p class="text-muted mb-0"><?php echo e(Auth::guard('student')->user()->username); ?></p>
                            </div>
                            ...
                            <div class="border-top pt-3">
                                <ul class="list-unstyled">
                                    ...
                                    <li class="mb-3">
                                        <a href="<?php echo e(route('student.logout')); ?>" class="d-flex align-items-center py-2 px-3 text-danger text-decoration-none hover-bg-light rounded" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
...
<?php /**PATH /Users/lifeofrence/Downloads/PROJECTCODE/inclaproject/incla/resources/views/spartials/navbar.blade.php ENDPATH**/ ?>