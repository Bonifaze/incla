            ...
            <div class="container-fluid">
                ...
                <div class="col_full">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-4">
                            <a href="/complain" class=" <?php echo $__env->yieldContent('/'); ?>">
                                <div class="card card-stats card-round">
                                    <div class="card-body hover-card shadow-sm">
                                        <div class="row align-items-center">
                                            <div class="col-icon">
...
<?php echo $__env->make('layouts.student', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/lifeofrence/Downloads/PROJECTCODE/inclaproject/incla/resources/views/students/home.blade.php ENDPATH**/ ?>