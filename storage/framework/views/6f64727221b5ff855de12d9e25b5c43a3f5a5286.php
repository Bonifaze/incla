                                ...
                                <div class="app-card app-card-account shadow-lg rounded-3">
                                    <div class="app-card-header p-4 border-bottom">
                                        ...
                                        <h4 class="app-card-title">Student Bio Data <a class="btn btn-info"
                                            href="<?php echo e(route('student.editbio', $student->id)); ?>"> <i class="fa fa-edit"></i>
                                            Edit </a> </h4>
                                        ...
                                        <div class="info-section">
                                         ...
                                         <div class="info-item py-3">
                                            ...
                                            <h4 class="app-card-title"><a class="btn btn-info"
                                                href="<?php echo e(route('student-medical.editbio', $medical->id)); ?>"> <i
                                ...
                                <div class="app-card app-card-account shadow-lg rounded-3">
                                     <div class="app-card-header p-4 border-bottom">
                                        ...
                                        <h4 class="app-card-title">Sponsor Details <a class="btn btn-info"
                                            href="<?php echo e(route('student-contact.editbio', $contact->id)); ?>"> <i
                                                class="fa fa-edit"></i> Edit </a></h4>
                                    </div>
                                    <div class="app-card-body p-4">
                                        <div class="info-section">
...
<?php echo $__env->make('layouts.student', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/lifeofrence/Downloads/PROJECTCODE/inclaproject/incla/resources/views/students/show.blade.php ENDPATH**/ ?>