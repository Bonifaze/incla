            ...
            <li class="nav-item has-treeview <?php echo $__env->yieldContent('results-open'); ?>">
                ...
                <ul class="nav nav-treeview ml-4">
                    ...
                    <li class="nav-item">
                     ...
                     <li class="nav-item">
                        <a href="<?php echo e(route('student.report')); ?>" class="nav-link <?php echo $__env->yieldContent('departments'); ?>"
                            target="_blank">
                            <i class="fas fa-list-alt nav-icon"></i>
                            <p>Report</p>
                        </a>
...
<?php /**PATH C:\Users\Lawrence Chris\Downloads\Onoyima (1)\work\incla\resources\views/partialsv3/sidebar.blade.php ENDPATH**/ ?>