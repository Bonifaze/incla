...
unset($__errorArgs, $__bag); ?>" name="role"
                                            value="<?php echo e(old('role')); ?>" required autocomplete="role" placeholder="Role"
                                            autofocus>
                                ...
                                <div class="form-group">
                                    <div class="form-group">
                                        <input id="role_description" type="text"
                                            class="form-control <?php $__errorArgs = ['role_description'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                            name="role_description" value="<?php echo e(old('role_description')); ?>" required
...
<?php echo $__env->make('layouts.mini', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Lawrence Chris\Desktop\laraproject\resources\views/admissions/addRole.blade.php ENDPATH**/ ?>