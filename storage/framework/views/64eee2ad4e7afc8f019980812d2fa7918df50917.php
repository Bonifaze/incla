        ...
        <div class="card mb-4">
            ...
            <div class="card-body p-5">
                ...
                <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade<?php echo e($forms->status == 0 ? ' show active' : ''); ?>" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab">
...
unset($__errorArgs, $__bag); ?>" name="surname" placeholder="<?php echo e($forms->surname); ?>" readonly autofocus>
                                    <input id="status" type="hidden" class="form-control " name="'<?php echo e($forms->status); ?>" readonly autofocus>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="form-group">
                                    <label for=""><?php echo e(__('First Name')); ?> </label>
                                    <input id="first_name" type="text" class="form-control" name="first_name" placeholder="<?php echo e($forms->first_name); ?>" readonly autofocus>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="form-group">
                                    <label for=""><?php echo e(__('Email')); ?> </label>
                                    <input id="email" type="email" class="form-control " name="email" placeholder="<?php echo e($forms->email); ?>" readonly autofocus>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="form-group">
                                    <label for=""><?php echo e(__('Phone')); ?> </label>
                                    <input id="phone" type="phone" class="form-control" name="phone" autocomplete="phone" placeholder="<?php echo e($forms->phone); ?>" readonly autofocus>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="form-group">
                                    <label for=""><?php echo e(__('Middle Name')); ?> </label>
                                    <input id="middle_name" type="text" class="form-control" name="middle_name" placeholder="<?php echo e($forms->middle_name ?? null); ?>" value="<?php echo e($forms->middle_name ?? null); ?>" readonly autofocus>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label for="lang_spoke"><?php echo e(__('Language Spoken')); ?> </label>
    ...
    <div class="form-group">
        ...
        <?php echo e(Form::select(
            ...
            ['class' => 'form-control select2', 'placeholder' => '-- Select Program --']
                            ...
                            <div class="form-group">
                                <label for="ppt"><?php echo e(__('Previous Project Topic')); ?> </label>
                            ...
                            <?php echo csrf_field(); ?>
                            <?php if($forms->applicant_type=='Licentiate'): ?>
                                 <div class="form-group">
                                ...
                                <?php endif; ?>
                                <label for="passport"><?php echo e(__('Upload Degree Certificate ')); ?>
  ...
  <div class="form-group">
                            ...
                            <div class="form-group">
                              ...
                              <label for="passport"><?php echo e(__('Upload  Result (if any)')); ?>
...
<?php echo $__env->make('layouts.adminsials', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/lifeofrence/Downloads/inclaproject/incla/resources/views/admissions//forms.blade.php ENDPATH**/ ?>