                ...
                <div class="card-body p-5">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button
                                class="nav-link<?php echo e($de->status == 0 ? ' active' : ''); ?> text-success fw-bold text-capitalize"
                                id="home-tab" data-bs-toggle="tab" data-bs-target="#home-tab-pane" type="button"
                                role="tab" aria-controls="home-tab-pane"
                                aria-selected="<?php echo e($de->status == 0 ? 'true' : 'false'); ?>">Bio Data</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button
                                class="nav-link<?php echo e($de->status == 1 ? ' active' : ''); ?> text-success fw-bold text-capitalize"
                                id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile-tab-pane" type="button"
                                role="tab" aria-controls="profile-tab-pane"
                                aria-selected="<?php echo e($de->status == 1 ? 'true' : 'false'); ?>">Sponsor Information</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button
                                class="nav-link<?php echo e($de->status == 2 ? ' active' : ''); ?> text-success fw-bold text-capitalize"
                                id="profile2-tab" data-bs-toggle="tab" data-bs-target="#profile2-tab-pane" type="button"
                                role="tab" aria-controls="profile2-tab-pane"
                                aria-selected="<?php echo e($de->status == 2 ? 'true' : 'false'); ?>">Direct Entry Information</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button
                                class="nav-link<?php echo e($de->status == 3 ? ' active' : ''); ?> text-success fw-bold text-capitalize"
                                id="profile3-tab" data-bs-toggle="tab" data-bs-target="#profile3-tab-pane" type="button"
                                role="tab" aria-controls="profile3-tab-pane"
                                aria-selected="<?php echo e($de->status == 3 ? 'true' : 'false'); ?>">Upload Documents</button>
                        </li>
                    </ul>
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade<?php echo e($de->status == 0 ? ' show active' : ''); ?>" id="home-tab-pane"
...
unset($__errorArgs, $__bag); ?>" name="surname"
                                            placeholder="<?php echo e($de->surname); ?>" readonly autofocus>
                                        <input id="status" type="hidden" class="form-control "
                                            name="'<?php echo e($de->status); ?>" readonly autofocus>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <input id="first_name" type="text" class="form-control" name="first_name"
                                            placeholder="<?php echo e($de->first_name); ?>" readonly autofocus>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <input id="email" type="email" class="form-control " name="email"
                                            placeholder="<?php echo e($de->email); ?>" readonly autofocus>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <input id="phone" type="phone" class="form-control" name="phone"
                                            autocomplete="phone" placeholder="<?php echo e($de->phone); ?>" readonly autofocus>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <input id="middle_name" type="text" class="form-control" name="middle_name"
                                            placeholder="<?php echo e($de->middle_name ?? null); ?>"
                                            value="<?php echo e($de->middle_name ?? null); ?>" readonly autofocus>
                                    </div>
                                </div>
                ...
                <div class="tab-pane fade<?php echo e($de->status == 1 ? ' show active' : ''); ?>" id="profile-tab-pane"
                    ...
                    <form method="POST" action="/desponsors" enctype="multipart/form-data" class="p-3">
                        ...
                        <div class="form-group">
                            <div class="form-group">
                                ...
                                <input id="phone" type="text" name="sponsors_phone" class="form-control"
                        ...
                        <div class="form-group">
                            <div class="form-group">
                                <label for=""><?php echo e(__('Email')); ?> </label>
                                <input id="foccupation" type="text" name="sponsors_email" class="form-control"
                        ...
                        <div class="form-group">
                            <div class="form-group">
                                ...
                                <textarea id="address" type="text" class="form-control" name="sponsors_address"
                        ...
                        <div class="form-group">
                            ...
                            <input id="foccupation" type="text" name="occupation" class="form-control"
                ...
                <div class="tab-pane fade<?php echo e($de->status == 2 ? ' show active' : ''); ?>" id="profile2-tab-pane"
                    role="tabpanel" aria-labelledby="profile2-tab">
                    <form method="POST" action="/deinformation" class="p-3">
                        ...
                        <div class="form-group">
                            <div class="form-group">
                                ...
                                <input id="score" type="text" name="jamb_de_no" class="form-control"
                                    placeholder="Jamb DE number" autofocus>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input id="first_choice" type="text" name="qualification_year" class="form-control"
                                placeholder="Year Qualification was Obtained" autofocus>
                        </div>
                        <div class="form-group">
                            <label for=""><?php echo e(__('Qualification Number')); ?> </label>
                            <input id="second_choice" type="text" name="qualification_number" class="form-control"
                                placeholder="Qualification Number" autofocus>
                        </div>
                ...
                <div class="tab-pane fade<?php echo e($de->status == 3 ? ' show active' : ''); ?>" id="profile3-tab-pane"
                    role="tabpanel" aria-labelledby="profile3-tab">
...
<?php echo $__env->make('layouts.adminsials', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/lifeofrence/Documents/laraproject/resources/views/admissions//de.blade.php ENDPATH**/ ?>