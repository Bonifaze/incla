<?php $__env->startSection('pagetitle'); ?> Edit Staff <?php $__env->stopSection(); ?>
...
<div class="content-wrapper">
 ...
 <h1
            ...
            <!-- form start -->
						...
						<?php echo Form::model($staff, ['method' => 'PATCH','route' => ['staff.update', $staff->id], 'class' => 'nobottommargin', 'files' => true]); ?>
              ...
              <div class="box-body">
              			...
              			<div  <?php if($errors->has('surname')): ?> class ='has-error form-group' <?php endif; ?>>
							...
							<div class="col-md-4 form-group">
								...
								<?php echo Form::text('username', null, array('placeholder' => '@veritas.edu.ng', 'class' => 'form-control', 'id' => 'username', 'name' => 'username')); ?>
...
<?php echo $__env->make('layouts.mini', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/lifeofrence/Downloads/PROJECTCODE/inclaproject/incla/resources/views/staff/admin/edit.blade.php ENDPATH**/ ?>