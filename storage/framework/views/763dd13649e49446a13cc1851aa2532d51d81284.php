              ...
              <h3 class="box-title">Work Information</h3>
              			...
              			<div  <?php if($errors->has('employment_type_id')): ?> class ='has-error form-group' <?php endif; ?>>
							...
							<div  <?php if($errors->has('username')): ?> class ='has-error form-group' <?php endif; ?>>
								...
								<?php echo Form::email('username', null, array( 'placeholder' => '@incla.edu.ng','class' => 'form-control', 'id' => 'username', 'required' => 'required')); ?>
							...
							<div class="col-md-4 form-group">
								...
								<?php echo Form::text('appointment_date', '2024-07-01', array('placeholder' => '', 'class' => 'form-control', 'id' => 'appointment_date', 'required' => 'required')); ?>
...
<?php echo $__env->make('layouts.mini', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/lifeofrence/Downloads/inclaproject/incla/resources/views/staff/admin/create.blade.php ENDPATH**/ ?>