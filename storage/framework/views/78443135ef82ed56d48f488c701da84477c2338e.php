...
unset($__errorArgs, $__bag); ?>"
                                                            ...
                                                            <input id="status" type="hidden" class="form-control "
                                                                name="status" value="<?php echo e($utme->status); ?>" readonly
                                                                autofocus>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="form-group">
                                                            ...
                                                            <input id="first_name" type="text" class="form-control"
                                                                name="first_name" placeholder="<?php echo e($utme->first_name); ?>"
                                                                readonly autofocus>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <?php endif; ?>
                                                        <label for="passport"><?php echo e(__('Upload Passport Photograph (.jpeg, .png, .jpg)')); ?>
                                            ...
                                            <div class="tab-pane fade" id="profile3-tab-pane" role="tabpanel"
                                                ...
                                                <form method="POST" action="/utmeuploads"enctype="multipart/form-data"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <?php endif; ?>
                                                        <label for="passport"><?php echo e(__('jamb Result(.jpeg, .png, .jpg)')); ?><b class="text-danger"> (Picture format)</b>
                                                        </label>
...
<?php echo $__env->make('layouts.userapp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/lifeofrence/Documents/laraproject/resources/views/admissions//utme.blade.php ENDPATH**/ ?>