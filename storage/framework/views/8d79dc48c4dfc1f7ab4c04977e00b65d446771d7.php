							  ...
							  <td><?php echo e($stf->fullName); ?></td>
							   <td> <?php echo e($stf->username); ?></td>
							    <td> <?php echo e($stf->phone); ?> </td>
							     <td><a href="<?php echo e(route('staff.view',$stf->id)); ?>" class="btn btn-default"> View </a></td>
...
<?php echo $__env->make('layouts.mini', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Lawrence Chris\Desktop\laraproject\resources\views/staff/admin/list.blade.php ENDPATH**/ ?>