                                        ...
                                        <div class="card rounded-4 shadow-lg border-0">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="mb-4 text-center">
                                                    <img src="data:image/jpg;base64,<?php echo e($applicantsDetails->passport); ?>" alt="Applicant Passport" class="rounded-circle shadow-lg border-4 border-primary" style="width: 100px; height: 100px; max-width: 100%; object-fit: cover;">
                                                </div>

                                                <!-- Name Details -->
                                                <div class="bio-details">
                                                    <p class="fs-5 text-dark fw-bold d-flex justify-content-between mb-3">Surname: <span class="text-muted"><?php echo e($applicantsDetails->surname); ?></span></p>
                                                    <p class="fs-5 text-dark fw-bold d-flex justify-content-between mb-3">First Name: <span class="text-muted"><?php echo e($applicantsDetails->first_name); ?></span></p>
                                                    <p class="fs-5 text-dark fw-bold d-flex justify-content-between mb-3">Other Name: <span class="text-muted"><?php echo e($applicantsDetails->middle_name); ?></span></p>
                                                </div>
                                                ...
                                                <div class="bio-data-fields">
                                                    ...
                                                    <div class="d-flex justify-content-between mb-3">
                                                        ...
                                                        <div class="text-dark ms-auto"><?php echo e($applicantsDetails->state_origin); ?></div>

                                                        <div class="fw-bold text-muted">LGA:</div>
                                                        <div class="text-dark ms-auto"><?php echo e($applicantsDetails->lga); ?></div>
                                                    </div>
                                            ...
                                            <div class="card-body">
                                                <div class="bio-data-fields">
                                                    <div class="d-flex justify-content-between mb-3">
                                                        ...
                                                        <div class="text-dark"><?php echo e($applicantsDetails->sponsor_surname); ?></div>
                                                    </div>
                                                
                                                    <div class="d-flex justify-content-between mb-3">
                                                        <div class="fw-bold text-muted">Sponsors Email:</div>
                                                        <div class="text-dark"><?php echo e($applicantsDetails->sponsors_email); ?></div>
                                                    </div>

                                                    <div class="d-flex justify-content-between mb-3">
                                                        <div class="fw-bold text-muted">Sponsors Phone Number:</div>
                                                        <div class="text-dark"><?php echo e($applicantsDetails->sponsors_phone); ?></div>
                                                    </div>

                                                    <div class="d-flex justify-content-between mb-3">
                                                        <div class="fw-bold text-muted">Sponsors Address:</div>
                                                        <div class="text-dark"><?php echo e($applicantsDetails->sponsors_address); ?></div>
                                                    </div>
                                                    <br>
                                                    <br>
                                                    <br>
                                                    ...
                                                    <div class="d-flex justify-content-between mb-3">
                                                        ...
                                                        <div class="text-dark"><b><?php echo e($applicantsDetails->admission_type); ?></b></div>
                                                    </div>

                                                    <div class="d-flex justify-content-between mb-3">
                                                        <div class="fw-bold text-muted">Course Applied:</div>
                                                        <div class="text-dark"><b><?php echo e($applicantsDetails->course_program); ?></b></div>
                                                    </div>

                                                    <div class="d-flex justify-content-between mb-3">
                                                        <div class="fw-bold text-muted">School Attended:</div>
                                                        <div class="text-dark"><b><?php echo e($applicantsDetails->school_attended); ?></b></div>
                                                    </div>

                                                    <div class="d-flex justify-content-between mb-3">
                                                        <div class="fw-bold text-muted">Certificates Obtained:</div>
                                                        <div class="text-dark"><b><?php echo e($applicantsDetails->certificates_obtained); ?></b></div>
                                                    </div>

                                                    <div class="d-flex justify-content-between mb-3">
                                                        <div class="fw-bold text-muted">Previous Project Topic:</div>
                                                        <div class="text-dark"><b><?php echo e($applicantsDetails->pr_topic); ?></b></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-6 mb-3">
                        <div class="image-container">
                            <img class="mx-auto d-block zoom-img" src="data:image/jpeg;base64,<?php echo e($applicantsDetails->cert); ?>" alt="Degree Certificate" style="height: 510px; width: 100%; object-fit: cover;">
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-6 mb-3">
                        <div class="image-container">
                            <img class="mx-auto d-block zoom-img" src="data:image/jpeg;base64,<?php echo e($applicantsDetails->olevel1); ?>" alt="Olevel Second Sitting" style="height: 500px; width: 100%; object-fit: cover;">
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.mini', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/lifeofrence/Downloads/inclaproject/incla/resources/views/admissions/layouts/viewUtmeApplicants.blade.php ENDPATH**/ ?>