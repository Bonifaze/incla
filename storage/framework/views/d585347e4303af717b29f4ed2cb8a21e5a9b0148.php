<aside class="main-sidebar sidebar-dark-primary elevation-4 nav-flat" style="background-color: #218c74; color: #fff">
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                <img src="data:image/png;base64,<?php echo e(Auth::guard('staff')->user()->passport); ?>" class="img-circle elevation-2" alt="User Image" style="width: 50px;">
            </div>
        ...
        <nav class="mt-2">
            ...
            <ul class="nav nav-treeview">
                ...
                <li class="nav-item has-treeview <?php echo $__env->yieldContent('exam-officers-open'); ?>">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item ml-4">
                            <a href="<?php echo e(route('result.program_search_student')); ?>" class="nav-link <?php echo $__env->yieldContent('exam-remark'); ?>">
                                <i class="fas fa-search-dollar nav-icon"></i>
                                <p>Result & Remark </p>
                            </a>
                        </li>
                        <li class="nav-item ml-4">
                            <a href="<?php echo e(route('exam_officer.program')); ?>" class="nav-link <?php echo $__env->yieldContent('exam-download'); ?>">
                                <i class="fas fa-list-alt nav-icon"></i>
                                <p>Result Download</p>
                            </a>
                        </li>
            ...
            <li class="nav-item has-treeview <?php echo $__env->yieldContent('exam-officers-open'); ?>">
                ...
                <ul class="nav nav-treeview ml-4">
                    ...
                    <li class="nav-item"><a href="<?php echo e(route('academia.department.list')); ?>" class="nav-link <?php echo $__env->yieldContent('exam-remark'); ?>"> <i class="fas fa-list-alt nav-icon"></i>
                            <p>List
                                Departments</p>
                        </a></li>
                    <li class="nav-item"><a href="<?php echo e(route('academia.program.list')); ?>" class="nav-link <?php echo $__env->yieldContent('exam-remark'); ?>"> <i class="fas fa-list-alt nav-icon"></i>
                            <p>List
                                Programs</p>
                        </a></li>
                ...
                <ul class="nav nav-treeview ml-4">
                    ...
                    <li class="nav-item has-treeview <?php echo $__env->yieldContent('exam-officers-open'); ?>">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="<?php echo e(route('student.list_level', 200)); ?>" class="nav-link <?php echo $__env->yieldContent('exam-remark'); ?>">
                                    <i class="fas fa-list-alt nav-icon"></i>
                                    <p>200 Level</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('student.list_level', 300)); ?>" class="nav-link <?php echo $__env->yieldContent('exam-download'); ?>">
                                    <i class="fas fa-list-alt nav-icon"></i>
                                    <p>300 Level</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('student.list_level', 400)); ?>" class="nav-link <?php echo $__env->yieldContent('exam-download'); ?>">
                                    <i class="fas fa-list-alt nav-icon"></i>
                                    <p>400 Level</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('student.list_level', 500)); ?>" class="nav-link <?php echo $__env->yieldContent('exam-download'); ?>">
                                    <i class="fas fa-list-alt nav-icon"></i>
                                    <p>500 Level</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('student.list_level', 600)); ?>" class="nav-link <?php echo $__env->yieldContent('exam-download'); ?>">
                                    <i class="fas fa-list-alt nav-icon"></i>
                                    <p>600 Level</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('student.list_level', 700)); ?>" class="nav-link <?php echo $__env->yieldContent('exam-download'); ?>">
                                    <i class="fas fa-list-alt nav-icon"></i>
                                    <p>PGD</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('student.list_level', 800)); ?>" class="nav-link <?php echo $__env->yieldContent('exam-download'); ?>">
                                    <i class="fas fa-list-alt nav-icon"></i>
                                    <p> Masters </p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('student.list_level', 900)); ?>" class="nav-link <?php echo $__env->yieldContent('exam-download'); ?>">
                                    <i class="fas fa-list-alt nav-icon"></i>
                                    <p>PhD</p>
                                </a>
                            </li>
                    ...
                    <li class="nav-item has-treeview <?php echo $__env->yieldContent('exam-officers-open'); ?>">
                        ...
                        <ul class="nav nav-treeview">
                          <li class="nav-item">
                                <a href="<?php echo e(route('student.list_session', 17)); ?>" class="nav-link <?php echo $__env->yieldContent('exam-remark'); ?>" >
                                    <i class="fas fa-list-alt nav-icon"></i>
                                    <p>2023/2024 </p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('student.list_session', 16)); ?>" class="nav-link <?php echo $__env->yieldContent('exam-remark'); ?>">
                                    <i class="fas fa-list-alt nav-icon"></i>
                                    <p>2022/2023 </p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('student.list_session', 15)); ?>" class="nav-link <?php echo $__env->yieldContent('exam-remark'); ?>">
                                    <i class="fas fa-list-alt nav-icon"></i>
                                    <p>2021/2022</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('student.list_session', 14)); ?>" class="nav-link <?php echo $__env->yieldContent('exam-download'); ?>">
                                    <i class="fas fa-list-alt nav-icon"></i>
                                    <p>2022/2021</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('student.list_session', 13)); ?>" class="nav-link <?php echo $__env->yieldContent('exam-download'); ?>">
                                    <i class="fas fa-list-alt nav-icon"></i>
                                    <p>2019/2020</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('student.list_session', 12)); ?>" class="nav-link <?php echo $__env->yieldContent('exam-download'); ?>">
                                    <i class="fas fa-list-alt nav-icon"></i>
                                    <p>2018/2019</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo e(route('student.list_session', 11)); ?>" class="nav-link <?php echo $__env->yieldContent('exam-download'); ?>">
                                    <i class="fas fa-list-alt nav-icon"></i>
                                    <p>2017/2018</p>
                                </a>
                            </li>
                    ...
                    <li class="nav-item">
                        <a href="<?php echo e(route('student.getGradStudent', 600)); ?>" class="nav-link <?php echo $__env->yieldContent('departments'); ?>" target="_blank">
                            <i class="fas fa-list-alt nav-icon"></i>
                            <p>UnderGraduate</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="<?php echo e(route('student.getGradStudent', 700)); ?>" class="nav-link <?php echo $__env->yieldContent('departments'); ?>" target="_blank">
                            <i class="fas fa-list-alt nav-icon"></i>
                            <p>PostGraduate</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="<?php echo e(route('student.getGradStudent', 1000)); ?>" class="nav-link <?php echo $__env->yieldContent('departments'); ?>" target="_blank">
                            <i class="fas fa-list-alt nav-icon"></i>
                            <p>Gradutaed</p>
                        </a>
                    </li>
            ...
            <li class="nav-item has-treeview <?php echo $__env->yieldContent('exam-officers-open'); ?>">
                ...
                <ul class="nav nav-treeview ml-4">
                    <li class="nav-item">
                        <a href="/utmePayment" class="nav-link <?php echo $__env->yieldContent('bursary-search'); ?>" target="_blank>
                            <i class="fa fa-eye nav-icon"></i>
                            <p>Undergraute</p>
                        </a>
                    </li>
            ...
            <li class="nav-item has-treeview <?php echo $__env->yieldContent('bursary-open'); ?>">
                ...
                <ul class="nav nav-treeview">
                    ...
                    <li class="nav-item"><a href="<?php echo e(route('session.listBursary')); ?>" class="nav-link <?php echo $__env->yieldContent('remita-list3'); ?>"> <i class="fa fa-eye nav-icon"></i>List
                            Sessions</a></li>
                </ul>
            ...
            <li class="spotlight-nav" style="background-color: #fff;">
                ...
                <a href="/spotlight/confirm" class="nav-link <?php echo $__env->yieldContent('soteria-search'); ?>" style="color: #218c74; width: 100%; font-weight: 700; font-size: 18px;">
                    <p>Spotlight</p>
                </a>
            </li>
...
</aside><?php /**PATH /Users/unnice/Desktop/workspace/laravel/laraproject/resources/views/partialsv3/sidebar.blade.php ENDPATH**/ ?>