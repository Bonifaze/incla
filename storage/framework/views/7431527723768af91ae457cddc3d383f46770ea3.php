                            ...
                            <div class="row gy-4 mb-4 mt-1">
                                                        ...
                                                        <div class="">
                                                            <ul class="list-group list-group-flush">
                                                                ...
                                                                <li class="list-group-item">Qualification:
                                                                    <b><?php echo e($applicantsDetails->qualification); ?></b></li>
                                                                <li class="list-group-item">Year Qualification Obatained:
                                                                    <b><?php echo e($applicantsDetails->qualification_year); ?></b></li>
                                                                ...
                                                                <li class="list-group-item">Qualification No.:
                                                                    <b><?php echo e($applicantsDetails->qualification_number); ?></b></li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <ul class="list-group list-group-flush">
                                    ...
                                    <li class="list-group-item">Address:
                                        <b><?php echo e($applicantsDetails->sponsors_address); ?></b></li>
...
<?php echo $__env->make('layouts.userapp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/lifeofrence/Documents/laraproject/resources/views/admissions//viewDEprofile.blade.php ENDPATH**/ ?>