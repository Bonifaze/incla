                                                    ...
                                                    <?php $__currentLoopData = $staff_courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $staff_course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php if($staff_course->course_id != $prev_course_id || $staff_course->staff_id != $prev_staff_id): ?>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <?php if($staff_course->hod_approval != 'pending'): ?>
...
<?php echo $__env->make('layouts.mini', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/lifeofrence/Downloads/inclaproject/incla/resources/views/results/approve_scores.blade.php ENDPATH**/ ?>