              ...
              <div class="box-body">
              		...
              		<div class="row">
              			...
              			<div class="col-md-6 form-group">
								...
								<?php echo Form::text('mat_no', null, array( 'placeholder' => 'VUG/CSC/17/2033 ','class' => 'form-control', 'id' => 'mat_no', 'required' => 'required')); ?>
              ...
              <div class="box-body">
              		...
              		<div class="row">
              			...
              			<div class="col-md-6 form-group">
								...
								<?php echo Form::text('mat_no', null, array( 'placeholder' => '6541','class' => 'form-control', 'id' => 'mat_no', 'required' => 'required')); ?>
...
<?php echo $__env->make('layouts.mini', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/lifeofrence/Downloads/inclaproject/incla/resources/views/results/search-student.blade.php ENDPATH**/ ?>