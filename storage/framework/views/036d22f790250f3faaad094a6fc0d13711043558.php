...
<table width="650" border="0" cellspacing="0" cellpadding="0" style="margin:auto" >
  <tr>
    <td height="650" valign="top"><table width="100%" height="174" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td align="center" valign="top"><h1><strong>Student Result </strong></h1></td>
      </tr>
    </table>
  ...
  <tr>
    <td height="650" valign="top"><table width="100%" height="174" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td align="center" valign="top"><h1><strong>
        <?php if($session->registered_courses1->first()?->semester==1): ?>
            First Semester  <?php echo e($session->name); ?>
 ...
 <table width="650" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="650" valign="top"><table width="100%" height="174" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td align="center" valign="top"><h1><strong>
        <?php if($session->registered_courses2->first()?->semester==2): ?>
            Second Semester  <?php echo e($session->name); ?>
...
<?php echo $__env->make('layouts.plain', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/lifeofrence/Documents/laraproject/resources/views/students/studentResult.blade.php ENDPATH**/ ?>