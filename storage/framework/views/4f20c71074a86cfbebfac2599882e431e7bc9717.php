 ...
 <div id="content">
                ...
                <body>
                 ...
                 <form action="" method="POST" onsubmit="event.preventDefault();" class="p-5">
                        ...
                        <button type="submit" onClick="makePayment2()" class="btn btn-success mt-3" id="rrrbtn">Generate RRR</button>
                    </div>
                </form>
...
<?php echo $__env->make('layouts.student', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/lifeofrence/Documents/laraproject/resources/views/students/RemitaPaymentOtherfee.blade.php ENDPATH**/ ?>