                                            ...
                                            <div class="card shadow mb-4">
                                                ...
                                                <div
                                                    ...
                                                    <div class="dropdown no-arrow">
                                                        <a href="/generatematricnumber"
                                                            class=" btn btn-sm btn-success shadow-sm"><i
                                                                class="fas fa-print text-white-50"></i> Generate
        ...
        <div class="col-12">
            <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    ...
                    <div class="dropdown no-arrow">
                        <a href="/viewprofile" class="btn btn-sm btn-success shadow-sm"><i
                                class="fas fa-id-badge text-white-50"></i> Full Profile</a>
                                            ...
                                            <div class="col-auto">
                                                ...
                                                <div class="rounded-circle">
                                                    <img class="rounded-circle p-3 mx-auto d-block"
                                                        src="data:image/<?php echo e($utm->passport_type); ?>;base64,<?php echo e(base64_encode($utm->passport)); ?>"
