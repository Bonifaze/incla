...
<div class="content-wrapper">
        ...
        <div class="col_full">
            ...
            <div class="card card-primary">
                    <h1
                      ...
                      <?php echo e($semesterName); ?> <?php echo e($level); ?> Level <?php echo e($session->currentSessionName()); ?> Result status SBC Approval
                    </h1>
 ...
 <td>                           <?php if(!$program->is_VCapproved): ?>
 <?php if(!$program->is_approved): ?>
                          <a href="/staff-course/approve?by=sbc&level=<?php echo e($level); ?> &program_id=<?php echo e($program->id); ?>" class="btn btn-outline-success" onclick="return confirm('are you sure you want to proceed with this action?')">Approve</a>
                                 <?php else: ?>
                          <a href="/staff-course/revoke?by=sbc&level=<?php echo e($level); ?> &program_id=<?php echo e($program->id); ?>" class="btn btn-outline-danger" onclick="return confirm('are you sure you want to proceed with this action?')">Revoke</a>
                                 <?php endif; ?>
...
<?php echo $__env->make('layouts.mini', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/lifeofrence/Documents/laraproject/resources/views/sbc/level_results.blade.php ENDPATH**/ ?>