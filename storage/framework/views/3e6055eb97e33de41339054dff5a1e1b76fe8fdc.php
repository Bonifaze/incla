                                    ...
                                    <div class="col-12">
                                        <div class="card shadow mb-4">
                                            ...
                                            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                                <h6 class="m-0 font-weight-bold text-success invisible">Admission Status :</h6>
                                                 <div class="dropdown no-arrow">
<a href="/generatematricnumber" class=" btn btn-sm btn-success shadow-sm"><i class="fas fa-print text-white-50"></i> Generate Matriculation Number</a>
                                ...
                                <div class="row justify-content-between align-items-center">
                                    <div class="col-auto">
                                        ...
                                        <div class="rounded-circle">
                                            <img class="rounded-circle p-3 mx-auto d-block" src="data:image/<?php echo e($utm->passport_type); ?>;base64,<?php echo e(base64_encode($utm->passport)); ?>" alt="Applicant Passport" style="height: 180px; width:200px;" />
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.userapp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Lawrence Chris\Desktop\laraproject\resources\views/admissions//completeadmission.blade.php ENDPATH**/ ?>