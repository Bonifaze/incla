        ...
        <table class="table table-bordered d-inline-flex p-2" cellspacing="0" width="60%">
            ...
            <tbody>
                <tr>
                    ...
                    <td><b>Amount: </b><?php echo e($receipt->amount); ?> </td>
                ...
                <tr>
                    ...
                    <td><b>RRR Date: </b> <?php echo e($receipt->created_at); ?></td>
                    <td><b>Payment Date: </b> <?php echo e($receipt->transaction_date); ?></td>
                </tr>
            </tbody>
        </table>
...
<?php /**PATH C:\Users\Lawrence Chris\Desktop\laraproject\resources\views/admissions/receipt.blade.php ENDPATH**/ ?>