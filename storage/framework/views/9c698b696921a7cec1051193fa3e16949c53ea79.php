...
<body>
   <?php $__currentLoopData = $deadmission; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $utm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<p align='center'><strong>Motto: Seeking the Truth </strong></p>
 ...
 <p align='center'> <img src="<?php echo e(asset('img/letter_logo.png')); ?>" width='100' height='100' border='0' /></p>
<p align='right'><strong>Date: <?php echo e(\Carbon\Carbon::parse($utm->approval_date)->format(' jS \of F Y ')); ?> </strong></p>
<p><strong>Dear Mr/Mrs/ Miss
<?php echo e($utm->first_name." ".$utm->middle_name." ".$utm->surname); ?>

</strong></p>
<p align='center'><strong><u>ADMISSION INTO FULL-TIME  DEGREE PROGRAMME</u></strong></p>
<p>Following your application through Direct-entry for the 2022/2023 academic session, I write to offer you a Provisional Admission into the
 <?php echo e($utm->duration); ?>

year Degree Programme to study <strong>
 <?php echo e($utm->course_applied); ?>

   in the Department of
   <?php echo e($facultyAndDept['dept']); ?>

   , Faculty of
    <?php echo e($facultyAndDept['col']); ?>
...
<p>If you accept the  offer, please Login into your Admission portal to pay a <u  style="color:red">NON-REFUNDABLE</u> acceptance fee of Sixty Thousand Naira (₦60, 000:00). The acceptance fee is NOT part of the  tuition fee.</p>
<p>You are therefore  expected to pay<strong> not less than a minimum of 50% of the total fees.</strong> Please  note that accommodation is reserved on first-come first-served basis, on  evidence of payment. The balance of the total fees is expected to be paid at  the beginning of the Second Semester of 2022/2023 session. </p>
<p><strong>This  offer of admission will lapse on 31th January, 2023 if the minimum  tuition and accommodation fees are not paid on or before that date. </strong>Please  consult our website <a href='http://www.veritas.edu.ng/'>www.veritas.edu.ng</a> for  fees, other charges and date of resumption.</p>
...
<?php /**PATH /Users/lifeofrence/Documents/laraproject/resources/views/admissions/deletterPDF.blade.php ENDPATH**/ ?>