...
<table width="650" border="0" cellspacing="0" cellpadding="0" style="margin:auto">
  <tr>
    <td height="650" valign="top"><table width="100%" height="174" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td height="138" valign="top"><h1>&nbsp;&nbsp;&nbsp;&nbsp;Note some of the courses might not have Senate Approval</h1></td>
        </tr>
      <tr>
        <td align="center" valign="top"><h1><strong>Academic  Result Admin View </strong></h1></td>
      </tr>
    </table>
	 ...
	 <?php $__currentLoopData = $sessions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $session): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <table width="100%" height="87" border="1" cellpadding="0" cellspacing="0">
                          <tr>
                            ...
                            <td colspan="2" align="center"><strong>LEVEL</strong>:
                             <?php echo e($session->registered_courses1admin->last()?->level); ?>
                          ...
                          <?php
                            ...
                            $tgp2 = 0;
                          ?>
                            <?php $__currentLoopData = $session->registered_courses1admin; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
      ...
      <table width="100%" border="1" cellpadding="0" cellspacing="0">
                          ...
                          <tr>
                            ...
                            <td>&nbsp;</td>
                            <td><span style="font-weight: bold">CGPA : <?php echo e(($tgp_cgpa+$tgp1) > 0 && ($tcu_cgpa+$tc1) > 0 ? number_format(($tgp_cgpa+$tgp1)/($tcu_cgpa+$tc1), 2) : '0.00'); ?></span></td>
                            <td>&nbsp; </td>
                          </tr>
...
<table width="100%" height="87" border="1" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td colspan="2" align="center"><strong>LEVEL</strong>:
     <?php echo e($session->registered_courses2admin->last()?->level); ?>
 ...
 SECOND
  ...
  <tr>
    ...
    <?php $__currentLoopData = $session->registered_courses2admin; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $result2): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <?php
...
<?php echo $__env->make('layouts.plain', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/lifeofrence/Downloads/PROJECTCODE/inclaproject/incla/resources/views/results/transcript.blade.php ENDPATH**/ ?>