            ...
            <li class="nav-item has-treeview @yield('results-open')">
                ...
                <ul class="nav nav-treeview ml-4">
                    ...
                    <li class="nav-item has-treeview @yield('exam-officers-open')">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('student.list_level', base64_encode(100)) }}" class="nav-link @yield('exam-remark')">
                                    <i class="fas fa-list-alt nav-icon"></i>
                                    <p> All students</p>
                                </a>
                            </li> 
                    ...
                    <li class="nav-item has-treeview @yield('exam-officers-open')">
                        ...
                        <ul class="nav nav-treeview">
                        <li class="nav-item">
                                <a href="{{ route('student.list_session', 5) }}"
                                    class="nav-link @yield('exam-remark')">
                                    <i class="fas fa-list-alt nav-icon"></i>
                                    <p>2025/2026 </p>
                                </a>
                        ...
                        <li class="nav-item">
                                <a href="{{ route('student.list_session', 4) }}"
                                    class="nav-link @yield('exam-remark')">
                                    <i class="fas fa-list-alt nav-icon"></i>
                                    <p>2024/2025 </p>
                                </a>
                        ...
                        <li class="nav-item">
                                <a href="{{ route('student.list_session', 3) }}"
                                    class="nav-link @yield('exam-remark')">
                                    <i class="fas fa-list-alt nav-icon"></i>
                                    <p>2023/2024 </p>
                                </a>
                            ...
                            <li class="nav-item">
                                <a href="{{ route('student.list_session', 2) }}"
                                    class="nav-link @yield('exam-remark')">
                                    <i class="fas fa-list-alt nav-icon"></i>
                                    <p>2022/2023 </p>
                                </a>
                            ...
                            <li class="nav-item">
                                <a href="{{ route('student.list_session', 1) }}"
