<aside class="main-sidebar sidebar-dark-primary elevation-4 nav-flat" style="background-color: #218c74; color: #fff">
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                <img src="data:image/png;base64,{{ Auth::guard('staff')->user()->passport }}" class="img-circle elevation-2" alt="User Image" style="width: 50px;">
            </div>

            <div class="info text-wrap">
                <a href="{{ route('staff.profile') }}" class="d-block">{{ Auth::guard('staff')->user()->full_name
                        }}</a>
            </div>
        </div>
        {{--
        ...
        <nav class="mt-2">
            ...
            <li class="nav-item has-treeview @yield('exam-officers-open')">
                ...
                <ul class="nav nav-treeview ml-4">
                    ...
                    <li class="nav-item"><a href="{{ route('academia.department.list') }}" class="nav-link @yield('exam-remark')"> <i class="fas fa-list-alt nav-icon"></i>
                            <p>List
                                Departments</p>
                        </a></li>
                    <li class="nav-item"><a href="{{ route('academia.program.list') }}" class="nav-link @yield('exam-remark')"> <i class="fas fa-list-alt nav-icon"></i>
                            <p>List
                                Programs</p>
                        </a></li>
            ...
            <li class="nav-item has-treeview @yield('results-open')">
                ...
                <ul class="nav nav-treeview ml-4">
                    ...
                    <li class="nav-item has-treeview @yield('exam-officers-open')">
                        ...
                        <ul class="nav nav-treeview">
                          <li class="nav-item">
                                <a href="{{ route('student.list_session', 17) }}" class="nav-link @yield('exam-remark')" >
                                    <i class="fas fa-list-alt nav-icon"></i>
                                    <p>2023/2024 </p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('student.list_session', 16) }}" class="nav-link @yield('exam-remark')">
                                    <i class="fas fa-list-alt nav-icon"></i>
                                    <p>2022/2023 </p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('student.list_session', 15) }}" class="nav-link @yield('exam-remark')">
                                    <i class="fas fa-list-alt nav-icon"></i>
                                    <p>2021/2022</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('student.list_session', 14) }}" class="nav-link @yield('exam-download')">
                                    <i class="fas fa-list-alt nav-icon"></i>
                                    <p>2022/2021</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('student.list_session', 13) }}" class="nav-link @yield('exam-download')">
                                    <i class="fas fa-list-alt nav-icon"></i>
                                    <p>2019/2020</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('student.list_session', 12) }}" class="nav-link @yield('exam-download')">
                                    <i class="fas fa-list-alt nav-icon"></i>
                                    <p>2018/2019</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('student.list_session', 11) }}" class="nav-link @yield('exam-download')">
                                    <i class="fas fa-list-alt nav-icon"></i>
                                    <p>2017/2018</p>
                                </a>
                            </li>
                    ...
                    <li class="nav-item">
                        <a href="{{ route('student.getGradStudent', 600) }}" class="nav-link @yield('departments')" target="_blank">
                            <i class="fas fa-list-alt nav-icon"></i>
                            <p>UnderGraduate</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('student.getGradStudent', 700) }}" class="nav-link @yield('departments')" target="_blank">
                            <i class="fas fa-list-alt nav-icon"></i>
                            <p>PostGraduate</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('student.getGradStudent', 1000) }}" class="nav-link @yield('departments')" target="_blank">
                            <i class="fas fa-list-alt nav-icon"></i>
                            <p>Gradutaed</p>
                        </a>
                    </li>
            ...
            <li class="nav-item has-treeview @yield('exam-officers-open')">
                ...
                <ul class="nav nav-treeview ml-4">
                    <li class="nav-item">
                        <a href="/utmePayment" class="nav-link @yield('bursary-search')" target="_blank>
                            <i class="fa fa-eye nav-icon"></i>
                            <p>Undergraute</p>
                        </a>
                    </li>
            ...
            <li class="nav-item has-treeview @yield('bursary-open')">
                ...
                <ul class="nav nav-treeview">
                    ...
                    <li class="nav-item"><a href="{{ route('session.listBursary') }}" class="nav-link @yield('remita-list3')"> <i class="fa fa-eye nav-icon"></i>List
                            Sessions</a></li>
                </ul>
                {{--
                        <li class="nav-item">
            ...
            <li class="spotlight-nav" style="background-color: #fff;">
                {{-- /rbac/auditviewall  --}}
                <a href="/spotlight/confirm" class="nav-link @yield('soteria-search')" style="color: #218c74; width: 100%; font-weight: 700; font-size: 18px;">
                    <p>Spotlight</p>
                </a>
            </li>
