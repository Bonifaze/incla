  ...
  <section class="invoice">
    ...
    <div class="row">
      ...
      <div class="col-xs-6">
        ...
        <img src="<?php echo asset('dist/img/credit/visa.png')?>" alt="Visa">
        <img src="<?php echo asset('dist/img/credit/mastercard.png')?>" alt="Mastercard">
        <img src="<?php echo asset('dist/img/credit/american-express.png')?>" alt="American Express">
        <img src="<?php echo asset('dist/img/credit/paypal2.png')?>" alt="Paypal">
