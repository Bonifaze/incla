                    ...
                    <body>
                        ...
                        <form action="" method="POST" onsubmit="event.preventDefault();" class="p-5">
                            <div class="dropdown no-arrow  btn btn-sm btn-success shadow-sm">
                                ...
                                <a href="{{ route('student.otherfeespayment') }}" class="nav-link @yield('results')">
                            ...
                            <div class="text-success font-weight-bold text-justify">ANNOUNCEMENT:Veritas University wishes to inform all parents that most accomodation spaces are now filled up. Please reach out to the Students' Affairs office and discuss accomodation options before making any further payment.</div>
                            ...
                            <div class="form-group container-fluid mt-5 p-5 border border-success shadow shadow-lg rounded rounded-lg">
                                ...
                                <div class="form-floating mb-3 mt-3">
                                    <input type="hidden" class="form-control" id="js-firstName" placeholder="{{ Auth::guard('student')->user()->full_name }}" value="{{ Auth::guard('student')->user()->full_name }}" name="firstName" readonly>
                                    <label for="email"></label>
                                </div>

                                <div class="form-floating mb-3 mt-3">
                                    <input type="hidden" class="form-control" id="js-email" placeholder="{{ Auth::guard('student')->user()->email }}" value="{{ Auth::guard('student')->user()->email }}" name="email" readonly>
                                    <label for="email"></label>
                                </div>

                                <div class="form-floating mb-3 mt-3">
                                    <input type="hidden" class="form-control" id="js-phone" placeholder="{{ Auth::guard('student')->user()->phone }}" value="{{ Auth::guard('student')->user()->phone }}" name="email" readonly>
                                    <label for="email"></label>
                                </div>
                                <div class="form-floating mb-3 mt-3">
                                    <input type="hidden" class="form-control" id="js-id" placeholder="{{ Auth::guard('student')->user()->id }}" value="{{ Auth::guard('student')->user()->id }}" name="email" readonly>
                                    <label for="email"></label>
                                </div>
