        ...
        <section class="content bg-white">
            ...
            <div class="container-fluid">
                ...
                <div class="col-4">
                    ...
                    <button onclick="resetPassword({{ $student->id }})" type="button"
                        class="{{ $student->id }} btn btn-danger"><span class="icon-line2-trash"></span> Reset
                        Password</button>
                    {!! Form::close() !!}
                </div>
                                ...
                                <div class="app-card app-card-account shadow-lg rounded-3">
                                    <div class="app-card-header p-4 border-bottom">
                                        ...
                                        <h4 class="app-card-title">Student Bio Data <a class="btn btn-info"
                                            href="{{ route('student.edit', $student->id) }}"> <i class="fa fa-edit"></i>
                                            Edit </a> </h4>
                                        ...
                                        <div class="info-section">
                                         ...
                                         <div class="info-item py-3">
                                            ...
                                            {{-- <h4 class="app-card-title"><a class="btn btn-info"
                                                href="{{ route('student-medical.edit', $medical->id) }}"> <i
                                ...
                                <div class="app-card app-card-account shadow-lg rounded-3">
                                     <div class="app-card-header p-4 border-bottom">
                                        ...
                                        <h4 class="app-card-title">Sponsor Details <a class="btn btn-info"
                                            href="{{ route('student-contact.edit', $contact->id) }}"> <i
                                                class="fa fa-edit"></i> Edit </a></h4>
                                    </div>
                                    <div class="app-card-body p-4">
                                        <div class="info-section">
