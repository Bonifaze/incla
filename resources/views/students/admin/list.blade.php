                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    @can('viewcourseform', 'App\StudentResult')
                                    <td><a class="btn btn-primary" href="{{ route('result.coursesReg_student', $student->id) }}"><i class="fa fa-eye"></i>
                                            Course Form</a></td>
                                    @else
                                    <td></td>
                                    @endcan
                                    ...
                                    <td> {!! Form::open(['route' => 'remita.find-student', 'method' => 'POST', 'class' => 'nobottommargin']) !!}
                                        ...
                                        <button type="submit" class="btn btn-success"><span class="icon-line2-trash"></span><i class="fa fa-eye"></i> Paid
                                        </button>
