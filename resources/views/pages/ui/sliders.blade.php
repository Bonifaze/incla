...
@section('css')
 <!-- bootstrap slider -->
  <link rel="stylesheet" href="<?php echo asset('plugins/bootstrap-slider/slider.css')?>">
...
@section('pagescript')
<!-- Bootstrap slider -->
<script src="<?php echo asset('plugins/bootstrap-slider/bootstrap-slider.js')?>"></script>
<script>
  $(function () {
    /* BOOTSTRAP SLIDER */
    $('.slider').slider()
