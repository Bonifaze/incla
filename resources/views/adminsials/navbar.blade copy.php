<nav class="main-header navbar navbar-expand navbar-white navbar-light mb-2" style="padding-bottom: 1.4rem;">
    ...
    <ul class="navbar-nav">
        <li class="nav-item">
            <a class="nav-link" style="color: #8c5721;" data-widget="pushmenu" href="#"><i class="fas fa-bars lg"></i></a>
        </li>
                ...
                <div class="dropdown">
                    ...
                    >
                        <span class="position-relative">
                            ...
                            <span
                                class="alarm-notify position-absolute end-0"
                            ></span>
                        </span>
                    </button>
                    <div
                    ...
                    >
                        <div
                            class="card border border-gray-100 rounded-12 box-shadow-custom p-0 overflow-hidden"
                        >
                            <div class="card-body p-0">
                                <div class="py-8 px-24 bg-main-600">
                                    <div class="flex-between">
                                        <h5
                                            class="text-xl fw-semibold text-white mb-0"
                                        >
                                            Notifications
                                        </h5>
                                ...
                                <div
                                    class="p-24 max-h-270 overflow-y-auto scroll-sm"
                                >
                                    <div
                                        class="d-flex align-items-start gap-12"
                                    >
                                        <img
                                        ...
                                        />
                                        <div
                                            class="border-bottom border-gray-100 mb-24 pb-24"
                                        >
                                            <div
                                            ...
                                            >
                                                ...
                                                >
                                                    <button
                                                        class="text-gray-200 rounded-4"
                                                        type="button"
                                                        data-bs-toggle="dropdown"
                                                        aria-expanded="false"
                                                    >
                                                        <i
                                                            class="ph-fill ph-dots-three-outline"
                                                        ></i>
                                                    </button>
                                                    <div
                                            ...
                                            >
                                                ...
                                                >
                                                    <p
                                                        class="text-gray-900 text-sm text-line-1"
                                                    >
                                                        Design brief and
                                                        ideas.txt
                                                    </p>
                                                    <span
                                                        class="text-xs text-gray-200 flex-shrink-0"
                                                        >2.2 MB</span
                                                    >
                                                </div>
                                            </div>
                                            <div
                                                class="mt-16 flex-align gap-8"
                                            >
                                                <button
                                                    type="button"
                                                    class="btn btn-main py-8 text-15 fw-normal px-16"
                                                >
                                                    Accept
                                                </button>
                                                <button
                                            ...
                                            <span
                                                class="text-gray-200 text-13 mt-8"
                                                >2 mins ago</span
                                            >
                                        </div>
                                    </div>
                                    ...
                                    >
                                        ...
                                        <div class="">
                                            <a
                                                ...
                                                on Design Assets - Smart
                                                Tags file:</a
                                            >
                                            <span
                                                class="text-gray-200 text-13"
                                                >2 mins ago</span
                                            >
                                        </div>
                                    </div>
                ...
                <div class="dropdown">
                    ...
                    >
                        ...
                        >
                            <div class="card-body">
                                <div
                                    class="max-h-270 overflow-y-auto scroll-sm pe-8"
                                >
                                    <div
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                />
                                                <span
                                                    class="text-15 fw-semibold mb-0"
                                                    >Arabic</span
                                                >
                                            </span>
                                        </label>
                        ...
                        <div class="card-body">
                            ...
                            >
                                ...
                                <div class="">
                                    ...
                                    <p
                                        class="fw-medium text-13 text-gray-200"
                                    >
                            ...
                            >
                                <li class="mb-4">
                                    ...
                                    >
                                        <span
                                            class="text-2xl text-primary-600 d-flex"
                                ...
                                <li
                                    class="pt-8 border-top border-gray-100"
                                >
                                    <a
                                        href="sign-in.html"
