                    ...
                    <div class="app-wrapper">
                        <div class="app-content pt-3 p-md-3 p-lg-4">
                            <div class="container-xl">
                                <h1 class="app-page-title h5 fw-bold p-2 shadow-sm text-center text-success mb-4 border">DE Applicant Profile</h1>
                                <div class="row gy-4">
                                                            ...
                                                            <ul class="list-group list-group-flush">
                                                             ...
                                                             <br>
                                                                        ...
                                                                        <div class="form-group">
                                                                            <div class="form-group">
                                                                                <input type="hidden" value="{{ $applicantsDetails->jamb_de_no }}" name="jamb_de_no">
