            ...
            <div class="card-body p-5">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link{{ $transfers->status == 0 ? ' active' : '' }} text-success fw-bold text-capitalize" id="home-tab" type="button" role="tab" aria-controls="home-tab-pane" aria-selected="{{ $transfers->status  == 0 ? 'true' : 'false' }}">Bio
                            Data</button>
                    </li>
                    <li class="nav-item" role="presentation">
