        ...
        <div class="card mb-4">
            ...
            <div class="card-body p-5">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link{{ $transfers->status  == 2 ? ' active' : '' }} text-success fw-bold text-capitalize" id="profile2-tab" data-bs-toggle="tab" data-bs-target="#profile2-tab-pane" type="button" role="tab" aria-controls="profile2-tab-pane" aria-selected="{{ $transfers->status  == 2 ? 'true' : 'false' }}">Direct Entry Information</button>
                    </li>
                    <li class="nav-item" role="presentation">
