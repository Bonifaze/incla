                                            ...
                                            <form method="POST" action="/transfersbiodata" enctype="multipart/form-data" class="p-3">
                                                ...
                                                <div class="form-group">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="status" type="hidden" class="form-control " name="status" value="{{ $transfers->status }}" readonly autofocus>
...
{{--
                                    ...
                                    <div class="tab-pane fade" id="profile3-tab-pane" role="tabpanel" aria-labelledby="profile3-tab" tabindex="0">
                                        ...
                                        {{--  <form method="POST" action="/transfersolevel" enctype="multipart/form-data" class="p-3">
                                            @csrf
