            ...
            <div class="card-body p-5">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link{{ $transfers->status == 0 ? ' active' : '' }} text-success fw-bold text-capitalize" id="home-tab" type="button" role="tab" aria-controls="home-tab-pane" aria-selected="{{ $transfers->status  == 0 ? 'true' : 'false' }}">Biodata</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link{{ $transfers->status  == 1 ? ' active' : '' }} text-success fw-bold text-capitalize" id="profile-tab" type="button" role="tab" aria-controls="profile-tab-pane" aria-selected="{{ $transfers->status  == 1 ? 'true' : 'false' }}">Sponsor Information</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link{{ $transfers->status  == 2 ? ' active' : '' }} text-success fw-bold text-capitalize" id="profile2-tab" type="button" role="tab" aria-controls="profile2-tab-pane" aria-selected="{{ $transfers->status  == 2 ? 'true' : 'false' }}">Trasnfer Information</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link{{ $transfers->status  == 3 ? ' active' : '' }} text-success fw-bold text-capitalize" id="profile3-tab" type="button" role="tab" aria-controls="profile3-tab-pane" aria-selected="{{ $transfers->status  == 3 ? 'true' : 'false' }}">Upload Documents</button>
                    </li>
                </ul>
