  ...
  <tr>
    <td height="650" valign="top"><table width="100%" height="174" border="0" cellpadding="0" cellspacing="0">
      ...
      <table width="100%" border="0">
        ...
        <tr>
          <td><strong>Name of Student: {{ session('userssurname') }}, {{ session('usersFirstName')}}  {{ session('usersmiddleName')}}  </strong></td>
          <td><strong>  Matric. No.: {{ session('usersmatno') }}  </strong></td>
        </tr>
        <tr>
            @php
                $col;
            @endphp
          <td><strong>Faculty:   {{ $facultyAndDept['col']}}  </strong></td>
          <td><strong>Gender: {{ session('usersgender') }}  </strong></td>
        </tr>
        <tr>
          <td><strong>Programme: {{ session('usersprogramName') }}  </strong></td>
          <td><strong>Dept:    {{ $facultyAndDept['dept'] }} </strong></td>
        </tr>
        <tr>
          <td height="21">&nbsp;</td>
          <td>&nbsp;</td>
        ...
        <table width="100%" height="87" border="1" cellpadding="0" cellspacing="0">
                          <tr>
                            ...
                            <td colspan="1" align="center"><strong>LEVEL: {{ session('level') }} </strong></td>
