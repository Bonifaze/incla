            ...
            {{--  <div class="modal fade" id="myModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <form method="POST" action="/studentsLogin" id="signup-form">
                        @csrf
                        <h2 class="form-title text-success">Students Login</h2>
                        <div class="form-group">

                            <div class="form-group">
                                <input id="email" type="email" class="form-input form-control @error('email') is-invalid @enderror" name="username" value="{{ old('email') }}" required autocomplete="email" placeholder="Email Address" autofocus>
                        ...
                        <div class="form-group">
                            <div class="form-group">
                                ...
                                <br>
                                <div>
                                    {{--  <a href="/register" class="text-success">Click Here </a> if you don't have an account  --}}
                                    <br>
