                            ...
                            <div class="form-left">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-row form-row-2">
                                        ...
                                        <input type="text" name="first_name" id="first_name" class="input-text" placeholder="{{ session('usersFirstName')}}" required readonly autofocus>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="form-row form-row-1">
...
{{--  This is for selecting state and lga  --}}
