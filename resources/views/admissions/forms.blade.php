...
<div class="content-wrapper bg-white">
            ...
            <div class="card-body p-5">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    {{--  <li class="nav-item" role="presentation">
                        <button class="nav-link{{ $forms->status == 0 ? ' active' : '' }} text-success fw-bold text-capitalize" id="home-tab" type="button" role="tab" aria-controls="home-tab-pane" aria-selected="{{ $forms->status  == 0 ? 'true' : 'false' }}">Biodata</button>
                    </li>  --}}
                    {{--  <li class="nav-item" role="presentation">
                        <button class="nav-link{{ $forms->status  == 1 ? ' active' : '' }} text-success fw-bold text-capitalize" id="profile-tab" type="button" role="tab" aria-controls="profile-tab-pane" aria-selected="{{ $forms->status  == 1 ? 'true' : 'false' }}">Sponsor Information</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link{{ $forms->status  == 2 ? ' active' : '' }} text-success fw-bold text-capitalize" id="profile2-tab" type="button" role="tab" aria-controls="profile2-tab-pane" aria-selected="{{ $forms->status  == 2 ? 'true' : 'false' }}">Jamb Information</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link{{ $forms->status  == 3 ? ' active' : '' }} text-success fw-bold text-capitalize" id="profile3-tab" type="button" role="tab" aria-controls="profile3-tab-pane" aria-selected="{{ $forms->status  == 3 ? 'true' : 'false' }}">Upload Documents</button>
                    </li>  --}}
                </ul>
                ...
                <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade{{ $forms->status == 0 ? ' show active' : '' }}" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab">
                        <form method="POST" action="/utmebiodata" enctype="multipart/form-data" class="p-3">
                            @csrf
                            <label for="">{{ __('Surname') }} </label>
                            <div class="form-group">
                                <div class="form-group">
                                    <input id="surname" type="text" class="form-control @error('surname') is-invalid @enderror" name="surname" placeholder="{{ $forms->surname }}" readonly autofocus>
                            ...
                            <div class="form-group">
                                <div class="form-group">
                                    ...
                                    <input id="first_name" type="text" class="form-control" name="first_name" placeholder="{{ $forms->first_name }}" readonly autofocus>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="form-group">
                                    <label for="">{{ __('Email') }} </label>
                                    <input id="email" type="email" class="form-control " name="email" placeholder="{{ $forms->email }}" readonly autofocus>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="form-group">
                                    <label for="">{{ __('Phone') }} </label>
                                    <input id="phone" type="phone" class="form-control" name="phone" autocomplete="phone" placeholder="{{ $forms->phone }}" readonly autofocus>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="form-group">
                                    <label for="">{{ __('Middle Name') }} </label>
                                    <input id="middle_name" type="text" class="form-control" name="middle_name" placeholder="{{ $forms->middle_name ?? null}}" value="{{ $forms->middle_name ?? null }}" readonly autofocus>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label for="lang_spoke">{{ __('Language Spoken') }} </label>

                                <div class="form-group">
                                    <input id="lang_spoke" type="text" class="form-control" name="lang_spoke" required>
                                </div>
                            </div>
    ...
    <div class="form-group">
        <label for="program">Program :</label>
         {{--  <select class="form-group select2 col-12 text-lg" name="course_applied">
        ...
        {{ Form::select(
            ...
            [
                ...
                'DSD' => 'Diploma in Spiritual Direction',
                'DCL' => 'Diploma in Theology of Consecrated Life',
                'LCL' => 'Licentiate in Theology of Consecrated Life',
            ],
            null, // Default selected value, or use a key like 'CBT' for a preselected option
            ['class' => 'form-control select2', 'placeholder' => '-- Select Program --']
        ) }}
    </div>
                            ...
                            <div class="form-group">
                                <label for="ppt">{{ __('Previous Project Topic') }} </label>

                                <div class="form-group">
                                    <input id="ppt" type="text" class="form-control" name="ppt" required>
                                </div>
                            </div>
                            ...
                            @csrf
                            @if ($forms->applicant_type=='Licentiate')
                                 <div class="form-group">
