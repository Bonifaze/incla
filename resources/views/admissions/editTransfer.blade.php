                                ...
                                <div class="card shadow mb-4 p-4">
                                    ...
                                    <div class="card-body">
                                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                                            ...
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link text-success fw-bold text-capitalize"
                                                    id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile-tab-pane"
                                                    type="button" role="tab" aria-controls="profile-tab-pane"
                                                    aria-selected="false">Sponsor Information</button>
                                            </li>
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link text-success fw-bold text-capitalize"
                                                    id="profile2-tab" data-bs-toggle="tab"
                                                    data-bs-target="#profile2-tab-pane" type="button" role="tab"
                                                    aria-controls="profile2-tab-pane" aria-selected="false">Transfer
                                                    Information</button>
                                            </li>
                                            {{-- <li class="nav-item" role="presentation">
                                                    <button class="nav-link text-success fw-bold text-capitalize" id="contact-tab" data-bs-toggle="tab"
                                                        data-bs-target="#contact-tab-pane" type="button" role="tab"
                                                        aria-controls="contact-tab-pane"
                                                        aria-selected="false">Academic Information</button>
                                                </li>  --}}
                                            {{-- <li class="nav-item" role="presentation">
                                                    <button class="nav-link text-success fw-bold text-capitalize" id="contact2-tab" data-bs-toggle="tab"
                                            ...
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link text-success fw-bold text-capitalize"
                                                    id="profile3-tab" data-bs-toggle="tab"
                                                    data-bs-target="#profile3-tab-pane" type="button" role="tab"
                                                    aria-controls="profile3-tab-pane" aria-selected="false">Uploaded
                                                    Documents</button>
                                            </li>
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link text-success fw-bold text-capitalize"
                                                    id="profile4-tab" data-bs-toggle="tab"
                                                    data-bs-target="#profile4-tab-pane" type="button" role="tab"
                                                    aria-controls="profile4-tab-pane"
                                        ...
                                        <div class="tab-content" id="myTabContent">
                                            <div class="tab-pane fade show active" id="home-tab-pane" role="tabpanel"
                                                ...
                                                <form method="POST" action="/editbiodata" enctype="multipart/form-data"
                                                    class="p-3">
                                                    @csrf
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            <input id="passport" type="file" class="form-control"
                                                                name="passport">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="form-group">
                                                            <input id="surname" type="text" class="form-control "
                                                                name="surname" value="{{ $applicantsDetails->surname }}"
                                                                autofocus readonly>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="form-group">
                                                            ...
                                                            <input id="first_name" type="text" class="form-control"
                                                                name="first_name"
                                                                value="{{ $applicantsDetails->first_name }}" autofocus
                                                                readonly>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="form-group">
                                                            ...
                                                            <input id="phone" type="phone" class="form-control"
                                                                name="phone" value="{{ $applicantsDetails->phone }}"
                                                                autofocus>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input id="middle_name" type="text" class="form-control"
                                                                name="middle_name"
                                                                value="{{ $applicantsDetails->middle_name }}" autofocus>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-select" name="gender">
                                                                <option value="{{ $applicantsDetails->gender }}">
                                                                    {{ $applicantsDetails->gender }}</option>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-group"> <label
                                                                for="">{{ __('Religion') }} </label>
                                                            <select class="form-select" name="religion">

                                                                <option value="{{ $applicantsDetails->religion }}">
                                                                    {{ $applicantsDetails->religion }}</option>
                                                                <option value="Christian (Catholic)">Christian (Catholic)
                                                                </option>
                                                                <option value="Christian (non-catholic)">Christian
                                                                    (non-catholic)</option>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            <input id="dob" type="date" class="form-control"
                                                                name="dob" value="{{ $applicantsDetails->dob }}">
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-select" name="nationality"
                                                                ...
                                                                <option value="{{ $applicantsDetails->nationality }}">
                                                                    {{ $applicantsDetails->nationality }}</option>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input id="state_origin" type="text" class="form-control"
                                                                name="state_origin"
                                                                value="{{ $applicantsDetails->state_origin }}">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input id="lga" type="text" class="form-control"
                                                                name="lga" value="{{ $applicantsDetails->lga }}">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input id="address" type="text" class="form-control"
                                                                name="address"
                                                                value="{{ $applicantsDetails->address }}">
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="form-group">
                                                            <select class="form-select" name="referral">
                                                                <option value="{{ $applicantsDetails->referral }}">
                                                                    {{ $applicantsDetails->referral }}</option>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="form-group">
                                                            ...
                                                            <input id="fname" type="text" name="name"
                                                                class="form-control"
                                                                value="{{ $applicantsDetails->name }}" autofocus>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="form-group">
                                                            ...
                                                            <input id="phone" type="text" name="sponsors_phone"
                                                                class="form-control"
                                                                value="{{ $applicantsDetails->sponsors_phone }}"
                                                                autofocus>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="form-group">
                                                            ...
                                                            <input id="foccupation" type="text" name="sponsors_email"
                                                                class="form-control"
                                                                value="{{ $applicantsDetails->sponsors_email }}"
                                                                autofocus>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="form-group">
                                                            ...
                                                            <input id="address" type="text" class="form-control"
                                                                ...
                                                                value="{{ $applicantsDetails->sponsors_address }}">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="form-group">
                                                            ...
                                                            <input id="foccupation" type="text" name="occupation"
                                                                class="form-control"
                                                                value="{{ $applicantsDetails->occupation }}" autofocus>
                                                        </div>
                                        ...
                                        <div class="tab-pane fade" id="profile4-tab-pane" role="tabpanel"
                                            aria-labelledby="profile4-tab" tabindex="0">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input id="institution" type="text" class="form-control"
                                                            name="institution"
                                                            value="{{ $applicantsDetails->institution }}" required
                                                            autofocus>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input id="score" type="text" class="form-control"
                                                            name="matric_no"
                                                            value="{{ $applicantsDetails->matric_no }}" autofocus
                                                            required>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input id="first_choice" type="text" name="entry_year"
                                                            class="form-control"
                                                            value="{{ $applicantsDetails->entry_year }}" autofocus
                                                            required>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-select" name="level">
                                                            <option value="{{ $applicantsDetails->level }}">
                                                                {{ $applicantsDetails->level }} </option>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input id="course" type="text" class="form-control"
                                                            name="course" value="{{ $applicantsDetails->course }}"
                                                            autofocus required>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input id="cpga" type="text" class="form-control"
                                                            name="cgpa" value="{{ $applicantsDetails->cgpa }}"
                                                            autofocus required>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-select" name="course_applied">
                                                            <option value="{{ $applicantsDetails->course_applied }}">
                                                                {{ $applicantsDetails->course_applied }}</option>
                                        ...
                                        <div class="tab-pane fade" id="profile3-tab-pane" role="tabpanel"
                                            ...
                                            <div class="row justify-content-between align-items-center">
                                                <div class="col-auto">
                                                    ...
                                                    <div class="rounded-circle">
                                                        <img class="rounded-circle p-3 mx-auto d-block" src="data:image/{{ $applicantsDetails ->olevel1_type }};base64,{{ base64_encode($applicantsDetails ->olevel1) }}" alt="Applicant Passport" style="height: 180px; width:200px;" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>  --}}
                                            ...
                                            <div class="row justify-content-between align-items-center">
                                                <div class="col-auto">
                                                    ...
                                                    <div class="rounded-circle">
                                                        <img class="rounded-circle p-3 mx-auto d-block" src="data:image/{{ $applicantsDetails ->olevel2_type }};base64,{{ base64_encode($applicantsDetails ->olevel2) }}" alt="Applicant Passport" style="height: 180px; width:200px;" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>  --}}
                                            ...
                                            {{--  <form method="POST" action="/editolevel" enctype="multipart/form-data" class="p-3">
                                            @csrf
                                            <p class="fw-bold text-warning">Please to Edit your olevel result kindly Submit result again</p <br>
