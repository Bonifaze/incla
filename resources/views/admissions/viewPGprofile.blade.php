             ...
             Postgradute Profile
                ...
                <div class="row card">
                    ...
                    <div class="row gy-4 mb-4 mt-1">
                        ...
                        {{-- <div class="card-body d-sm-flex align-items-center justify-content-between">
                        <h5 class="card-title text-success">Olevel</h5> <br>
