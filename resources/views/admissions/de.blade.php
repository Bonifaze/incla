    ...
    <div class="content-wrapper bg-white">
        ...
        <section class="content">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body p-5">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button
                                class="nav-link{{ $de->status == 0 ? ' active' : '' }} text-success fw-bold text-capitalize"
                                id="home-tab" data-bs-toggle="tab" data-bs-target="#home-tab-pane" type="button"
                                role="tab" aria-controls="home-tab-pane"
                                aria-selected="{{ $de->status == 0 ? 'true' : 'false' }}">Bio Data</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button
                                class="nav-link{{ $de->status == 1 ? ' active' : '' }} text-success fw-bold text-capitalize"
                                id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile-tab-pane" type="button"
                                role="tab" aria-controls="profile-tab-pane"
                                aria-selected="{{ $de->status == 1 ? 'true' : 'false' }}">Sponsor Information</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button
                                class="nav-link{{ $de->status == 2 ? ' active' : '' }} text-success fw-bold text-capitalize"
                                id="profile2-tab" data-bs-toggle="tab" data-bs-target="#profile2-tab-pane" type="button"
                                role="tab" aria-controls="profile2-tab-pane"
                                aria-selected="{{ $de->status == 2 ? 'true' : 'false' }}">Direct Entry Information</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button
                                class="nav-link{{ $de->status == 3 ? ' active' : '' }} text-success fw-bold text-capitalize"
                                id="profile3-tab" data-bs-toggle="tab" data-bs-target="#profile3-tab-pane" type="button"
                                role="tab" aria-controls="profile3-tab-pane"
                                aria-selected="{{ $de->status == 3 ? 'true' : 'false' }}">Upload Documents</button>
                        </li>
                    </ul>
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade{{ $de->status == 0 ? ' show active' : '' }}" id="home-tab-pane"
                                ...
                                <div class="form-group">
                                    <div class="form-group">
                                        <input id="surname" type="text"
                                            ...
                                            placeholder="{{ $de->surname }}" readonly autofocus>
                                        <input id="status" type="hidden" class="form-control "
                                            name="'{{ $de->status }}" readonly autofocus>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <input id="first_name" type="text" class="form-control" name="first_name"
                                            placeholder="{{ $de->first_name }}" readonly autofocus>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <input id="email" type="email" class="form-control " name="email"
                                            placeholder="{{ $de->email }}" readonly autofocus>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <input id="phone" type="phone" class="form-control" name="phone"
                                            autocomplete="phone" placeholder="{{ $de->phone }}" readonly autofocus>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <input id="middle_name" type="text" class="form-control" name="middle_name"
                                            placeholder="{{ $de->middle_name ?? null }}"
                                            value="{{ $de->middle_name ?? null }}" readonly autofocus>
                                    </div>
                                </div>
                ...
                <div class="tab-pane fade{{ $de->status == 1 ? ' show active' : '' }}" id="profile-tab-pane"
                ...
                <div class="tab-pane fade{{ $de->status == 2 ? ' show active' : '' }}" id="profile2-tab-pane"
                    ...
                    <form method="POST" action="/deinformation" class="p-3">
                        ...
                        <div class="form-group">
                            <div class="form-group">
                                <label for="">{{ __('Jamb DE Number') }} </label>
                        ...
                        <div class="form-group">
                            <label for="">{{ __('Qualification Year') }} </label>
                        ...
                        <div class="form-group">
                            <label for="">{{ __('Qualification Number') }} </label>
                ...
                <div class="tab-pane fade{{ $de->status == 3 ? ' show active' : '' }}" id="profile3-tab-pane"
