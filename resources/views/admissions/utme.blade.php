            ...
            <div class="card-body p-5">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link{{ $utme->status == 0 ? ' active' : '' }} text-success fw-bold text-capitalize" id="home-tab" data-bs-toggle="tab" data-bs-target="#home-tab-pane" type="button" role="tab" aria-controls="home-tab-pane" aria-selected="{{ $utme->status  == 0 ? 'true' : 'false' }}">Bio
                            Data</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link{{ $utme->status  == 1 ? ' active' : '' }} text-success fw-bold text-capitalize" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile-tab-pane" type="button" role="tab" aria-controls="profile-tab-pane" aria-selected="{{ $utme->status  == 1 ? 'true' : 'false' }}">Sponsor Information</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link{{ $utme->status  == 2 ? ' active' : '' }} text-success fw-bold text-capitalize" id="profile2-tab" data-bs-toggle="tab" data-bs-target="#profile2-tab-pane" type="button" role="tab" aria-controls="profile2-tab-pane" aria-selected="{{ $utme->status  == 2 ? 'true' : 'false' }}">Jamb Information</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link{{ $utme->status  == 3 ? ' active' : '' }} text-success fw-bold text-capitalize" id="profile3-tab" data-bs-toggle="tab" data-bs-target="#profile3-tab-pane" type="button" role="tab" aria-controls="profile3-tab-pane" aria-selected="{{ $utme->status  == 3 ? 'true' : 'false' }}">Upload Documents</button>
                    </li>
                </ul>
                    ...
                    <div class="tab-pane fade{{ $utme->status == 0 ? ' show active' : '' }}" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab">
                        <form method="POST" action="/transfersbiodata" enctype="multipart/form-data" class="p-3">
                            ...
                            <div class="form-group">
                                <div class="form-group">
                                    <input id="surname" type="text" class="form-control @error('surname') is-invalid @enderror" name="surname" placeholder="{{ $utme->surname }}" readonly autofocus>
                                    <input id="status" type="hidden" class="form-control " name="'{{ $utme->status }}" readonly autofocus>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="form-group">
                                    <label for="">{{ __('First Name') }} </label>
                                    <input id="first_name" type="text" class="form-control" name="first_name" placeholder="{{ $utme->first_name }}" readonly autofocus>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="form-group">
                                    <label for="">{{ __('Email') }} </label>
                                    <input id="email" type="email" class="form-control " name="email" placeholder="{{ $utme->email }}" readonly autofocus>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="form-group">
                                    <label for="">{{ __('Phone') }} </label>
                                    <input id="phone" type="phone" class="form-control" name="phone" autocomplete="phone" placeholder="{{ $utme->phone }}" readonly autofocus>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="form-group">
                ...
                <div class="tab-pane fade{{ $utme->status == 1 ? ' show active' : '' }}" id="profile-tab-pane" role="tabpanel" aria-labelledby="profile-tab">
                ...
                <div class="tab-pane fade{{ $utme->status == 2 ? ' show active' : '' }}" id="profile2-tab-pane" role="tabpanel" aria-labelledby="profile2-tab">
                    <form method="POST" action="/utmejamb" enctype="multipart/form-data" class="p-3">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-group col-12 text-lg" name="course_applied">
                                    ...
                                    @endforeach
                                                        ...
                                                        <label for="refferal">{{ __('UTME UNIVERSITY CHOICE:') }} </label>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <label for="refferal">{{ __('UTME SUBJECT :') }} </label>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                                <label for="refferal">{{ __('JAMB SCORE:') }} </label>
                            <div class="form-group">
                ...
                <div class="tab-pane fade{{ $utme->status == 3 ? ' show active' : '' }}" id="profile3-tab-pane" role="tabpanel" aria-labelledby="profile3-tab">
                    <form method="POST" action="/utmeuploads" enctype="multipart/form-data" class="p-3">
                        ...
                        <div class="form-check mb-3">
                            <input class="form-check-input" type="checkbox" name="olevel_awaiting" value="Awaiting Result" id="flexCheckDefault" style="width:100px; height:50px;"  >
