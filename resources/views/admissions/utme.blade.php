                                ...
                                <div class="card-body p-5">
                                        ...
                                        <div class="tab-pane fade show active" id="home-tab-pane" role="tabpanel"
                                            ...
                                            <form method="POST" action="/utmebiodata" enctype="multipart/form-data"
                                                ...
                                                <div class="form-group">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="status" type="hidden" class="form-control "
                                                            name="status" value="{{ $utme->status }}" readonly autofocus>
                                                ...
                                                <div class="form-group">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="first_name" type="text" class="form-control"
                                                            name="first_name" placeholder="{{ $utme->first_name }}" readonly
                                                            autofocus>
                                                ...
                                                <div class="form-group">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="middle_name" type="text" class="form-control"
                                                            name="middle_name"
                                                            placeholder="{{ $utme->middle_name ?? null }}"
                                                            value="{{ $utme->middle_name ?? null }}" readonly autofocus>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group" style="margin-top:0px" id="state1">
                                                    <div
                                                        @if ($errors->has('nationality')) class ='has-error form-group' @endif>
                                                ...
                                                <div class="form-group">
                                                    <div class="form-group">
                                                        <input id="state_origin" type="text" class="form-control"
                                                            name="state_origin" required placeholder="State of Origin">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="form-group">
                                                        <input id="lga" type="text" class="form-control"
                                                            name="lga" required placeholder="Local Government Area">
                                                    </div>
                                                </div>  --}}
                                    ...
                                    {{--  <div class="form-group">
                                        ...
                                        @if (session('statusMsg'))
                                            {!! session('statusMsg') !!}
                                        @endif
                                        <label for="passport">{{ __('Passport Photograph (.jpeg, .png, .jpg)') }}
                                        </label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <select class="col-md-12 form-group text-lg" name="referral">
                                    ...
                                    <form method="POST" action="/utmeuploads"enctype="multipart/form-data"
                                        ...
                                        <div class="form-group">
                                            ...
                                            @if (session('statusMsg'))
                                                {!! session('statusMsg') !!}
                                            @endif
                                            <label for="passport">{{ __('jamb Result(.jpeg, .png, .jpg)') }}<b
