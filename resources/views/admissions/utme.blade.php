                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <h3 class="h5 text-center fw-bold mb-4 pt-2">
                            <p class="fw-bold text-success">UTME</p> Registration Form
                        </h3>
                        <!-- Content Row -->
                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <div class="card-body p-5">
                                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                                            ...
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link text-success fw-bold text-capitalize"
                                                    ...
                                                    aria-controls="profile2-tab-pane" aria-selected="false">Jamb</button>
                                            </li>
                                            {{-- <li class="nav-item" role="presentation">
                                            <button class="nav-link text-success fw-bold text-capitalize" id="profile3-tab" data-bs-toggle="tab" data-bs-target="#profile3-tab-pane" type="button" role="tab" aria-controls="profile3-tab-pane" aria-selected="false">Olevel</button>
                                        </li> --}}
                                            ...
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link text-success fw-bold text-capitalize"
                                                    ...
                                                    aria-controls="profile3-tab-pane" aria-selected="false">Upload
                                                    Documents</button>
                                            </li>

                                        </ul>

                                        {{-- Handle the Biodata part that collect all the applicant information about his/herslef --}}
                                                ...
                                                <form method="POST" action="/utmebiodata" enctype="multipart/form-data"
                                                    ...
                                                    <div class="form-group">
                                                        <div class="form-group">
                                                            <input id="surname" type="text"
                                                                ...
                                                                name="surname" placeholder="{{ $utme->surname }}" readonly
                                                                autofocus>
                                                            <input id="status" type="hidden" class="form-control "
                                                                name="status" value="{{ $utme->status }}" readonly
                                                                autofocus>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="form-group">
                                                            ...
                                                            <input id="first_name" type="text" class="form-control"
                                                                name="first_name" placeholder="{{ $utme->first_name }}"
                                                                readonly autofocus>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="form-group">
                                                            ...
                                                            <input id="email" type="email" class="form-control "
                                                                name="email" placeholder="{{ $utme->email }}" readonly
                                                                autofocus>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="form-group">
                                                            ...
                                                            <input id="phone" type="phone" class="form-control"
                                                                ...
                                                                placeholder="{{ $utme->phone }}" readonly autofocus>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="form-group">
                                                            <input id="middle_name" type="text" class="form-control"
                                                                name="middle_name" placeholder="Other name" autofocus>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="form-group">
                                                            <input id="address" type="text" class="form-control"
                                                                name="address" required placeholder="Permanent Address" required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        @if (session('statusMsg'))
                                                            {!! session('statusMsg') !!}
                                                        @endif
                                                        <label for="passport">{{ __('Upload Passport Photograph (.jpeg, .png, .jpg)') }}
                                                        </label>
                                                    ...
                                                    {{-- <div class="form-group">
                                                        ...
                                                        @if (session('statusMsg'))
                                                            {!! session('statusMsg') !!}
                                                        @endif
                                                        <label for="passport">{{ __('jamb Passport Photograph') }}
                                                        </label>
                                                ...
                                                <form method="POST" action="/utmeuploads"enctype="multipart/form-data"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        @if (session('statusMsg'))
                                                            {!! session('statusMsg') !!}
                                                        @endif
                                                        <label for="passport">{{ __('jamb Result(.jpeg, .png, .jpg)') }}<b class="text-danger"> (Picture format)</b>
                                                        </label>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="passport">{{ __('Upload Olevel Result(.jpeg, .png, .jpg)') }}
                                                        </label>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="form-group">
                                                            <input id="fname" type="text" name="name"
                                                                class="form-control" placeholder="Sponsor Full Name"
                                                                autofocus>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="tab-pane fade" id="profile2-tab-pane" role="tabpanel"
                                            ...
                                            <form method="POST" action="/utmejamb" enctype="multipart/form-data"
                                                class="p-3">
                                                @csrf
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <input id="score" type="text" name="jamb_reg_no"
                                                            class="form-control" placeholder="Jamb Registration number"
                                                            autofocus>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <input id="first_choice" type="text" name="first_choice"
                                                            class="form-control" placeholder="University First Choice"
                                                            autofocus>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <input id="second_choice" type="text" name="second_choice"
                                                            class="form-control" placeholder="University Second Choice"
                                                            autofocus>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <input id="subject_1" type="text" name="subject_1"
                                                            class="form-control" placeholder="Subject one" autofocus>
                                                    </div>
                                                </div>
                                                <div class="form-group">

                                                    <div class="form-group">
                                                        <input id="subject_2" type="text" name="subject_2"
                                                            class="form-control" placeholder="Subject Two" autofocus>
                                                    </div>
                                                </div>
                                                <div class="form-group">

                                                    <div class="form-group">
                                                        <input id="subject_3" type="text" name="subject_3"
                                                            class="form-control" placeholder="Subject Three" autofocus>
                                                    </div>
                                                </div>
                                                <div class="form-group">

                                                    <div class="form-group">
                                                        <input id="subject_4" type="text" class="form-control"
                                                            name="subject_4" placeholder="Subject Four" autofocus>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <input id="score" type="text" name="score"
                                                            class="form-control" placeholder="Jamb Score" autofocus>
                                                    </div>
                                                </div>
                                                {{--  <div class="form-group">
                                        ...
                                        <div class="tab-pane fade" id="profile3-tab-pane" role="tabpanel"
                                            aria-labelledby="profile3-tab" tabindex="0">
                                            <form method="POST" action="/utmeolevel" enctype="multipart/form-data"
                                                class="">
                                                @csrf
                                                ...
                                                <div class="form-grop sbj2 mt-3">
                                                    <div class="btn-group">
                                                        ...
                                                        <select class="form-select bg-light mx-1" name="subject_2">
                                                            <option selected value="English Language" selected
                                                                class="bg-secondary">English Language</option readonly>
                                                            @foreach ($subjects as $subject)
                                                                <option disabled>{{ $subject->subject_name }}</option>
                                                            @endforeach
                                                        </select>
