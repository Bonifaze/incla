...
@section('pagetitle') Reset All Staff Password  @endsection
        ...
        <div class="col_full">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Reset All Staff Password</h3>
				</div>
						...
						<table class="table table-striped">
						  ...
						  <tbody>
							...
							<tr>
							    ...
							    <td>
							    {!! Form::open(['method' => 'POST', 'route' => 'rbac.refreshstaffcodes', 'id'=>'resetStaffForm']) !!}
...
<script src="{{ asset('dist/js/bootbox.min.js')}}"></script>
 ...
 <script>
        	...
        	{
             bootbox.dialog({
                message: "<h4>Confirm you want to reset all staff password</h4>",
                buttons: {
                    confirm: {
                        label: 'Yes',
                        className: 'btn-success',
                        callback: function(){
                        	document.getElementById("resetStaffForm").submit();
                        	}
                    },
                    cancel: {
                        label: 'No',
