...
@section('pagetitle')Admin Edit Device @endsection
      ...
      <div class="container-fluid">
        ...
        <div class="col_full">
            ...
            @include('partialsv3.flash')
				...
				{!! Form::model($device, ['method' => 'PATCH','route' => ['soteria.admin_update', $device->id], 'class' => 'nobottommargin', 'files' => true]) !!}
				 			<div class="card-body">
              ...
              <div class="box-body">
				  ...
				  <div class="col-md-4 form-group">
					  ...
					  {!! Form::text('ip_address', long2ip($device->ip_address), array( 'placeholder' => '10.10.5.1','class' => 'form-control', 'id' => 'ip address', 'required' => 'required')) !!}
