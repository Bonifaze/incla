        ...
        <div class="col_full">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Add Network Device for {{$student->fullName}} </h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
            @include('partialsv3.flash')
           
						{!! Form::open(array('route' => 'soteria.student.store', 'method'=>'POST', 'class' => 'nobottommargin')) !!}
 			<div class="card-body">
              ...
              <div class="box-body">
				  ...
				  {{ Form::hidden('full_name', $student->fullName) }}
