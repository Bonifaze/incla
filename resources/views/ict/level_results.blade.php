...
--}}
                                            <td>
                                                @if (!$program->is_DEANapproved)
                                                    <a href="/staff-course/approve?by=dean&level={{ $level }}&program_id={{ $program->id }}"
                                                ...
                                                @else
                                                    <a href="/staff-course/revoke?by=dean&level={{ $level }}&program_id={{ $program->id }}"
