...
<div class="content-wrapper">
        ...
        <div class="col_full">
            ...
            <div class="card card-primary">
                    <h1
                      ...
                      {{$semesterName}} {{$level}} Level {{$session->currentSessionName()}} <br>ICT Result status
                    </h1>
 ...
 <td>
                               @if(!$program->is_VCapproved)
                 <a href="/staff-course/approve?by=vc&level={{ $level}}&program_id={{ $program->id }}" class="btn btn-outline-success" onclick="return confirm('are you sure you want to proceed with this action?  Result will be made available for Student to View')">Publish</a>
                                 @else
                     <a href="/staff-course/revoke?by=vc&level={{ $level}}&program_id={{ $program->id }}" class="btn btn-outline-danger" onclick="return confirm('are you sure you want to proceed with this action?   Result will not be made available for Student to View')">Unpublish</a>
                                 @endif
                                 </td>
