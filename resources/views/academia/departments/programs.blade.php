        ...
        <div class="col_full">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">{{ $department->name }} Programs</h3>
                  </div>
							...
							<tr>
                             ...
                             <td>{{ $program->name }}</td>
							  <td> {{ $program->registeredStudentsCount(1000) }} </td>
                                <td><a class="btn btn-outline-info" href="{{ route('academia.department.manage_program',base64_encode($program->id)) }}">  View </a></td>
