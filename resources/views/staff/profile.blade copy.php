...
<div class="content-wrapper bg-white">
    ...
    <section class="content">
        ...
        <div class="container-fluid">
            ...
            <div>
                @can('rbac', 'App\Staff')
                <a class="btn btn-warning" href="{{ route('staff.show',$staff->id) }}">Edit Profile
                </a>
                @else
                @endcan
            </div>
                                ...
                                <div class="row justify-content-between align-items-center">
                                    <div class="col-auto">
                                        ...
                                        <div class="rounded-circle">
                                            <img class="rounded-circle p-3 mx-auto d-block" src="data:image/png;base64,{{ $staff->passport }}" alt="Student Passport" style="height: 200px; width:200px;" />
                                        </div>
                                    </div>
                                    <div class="col-auto">
                                        <div class="item-label mb-2">
                                        ...
                                        <div class="rounded-circle">
                                            <img class="rounded-circle p-3 mx-auto d-block" src="data:image/png;base64,{{ $staff->signature }}" alt="Student signature" style="height: 200px; width:200px;" />
                                        </div>
                                    </div>
                                </div>
                            </div>
