...
@section('pagetitle') Edit Staff @endsection
...
<div class="content-wrapper">
 ...
 <h1
            ...
            <!-- form start -->
						...
						{!! Form::model($staff, ['method' => 'PATCH','route' => ['staff.update', $staff->id], 'class' => 'nobottommargin', 'files' => true]) !!}
				<div class="card-body">
              ...
              <div class="box-body">
              			...
              			<div  @if($errors->has('surname')) class ='has-error form-group' @endif>
							...
							<div class="col-md-4 form-group">
								...
								{!! Form::text('username', null, array('placeholder' => '@veritas.edu.ng', 'class' => 'form-control', 'id' => 'username', 'name' => 'username')) !!}
