...
! function (t) {
    ...
    function B(e, n, a) {
        ...
        c = {
            ...
            error: function (n, a) {
                var r = Nt(e, null, "xhr", [e, null, e.jqXHR]); - 1 === t.inArray(!0, r) && ("parsererror" == a ? Lt(e, 0, "Invalid JSON response", 1) : 4 === n.readyState && Lt(e, 0, "Ajax error", 7)), ft(e, !1)
            }
            ...
            url: l || e.sAjaxSource
        })) : t.isFunction(l) ? e.jqXHR = l.call(s, n, u, e) : (e.jqXHR = t.ajax(t.extend(c, l)), l.data = i)
    }
    ...
    function Lt(t, n, a, r) {
        ...
        else if (n = qt.ext, n = n.sErrMode || n.errMode, t && Nt(t, null, "error", [t, r, a]), "alert" == n) alert(a);
        else {
            ...
            return this.each(function () {
                ...
                if ("table" != this.nodeName.toLowerCase()) Lt(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2);
                    ...
                    if (-1 !== t.inArray(!0, t.map(p, function (t) {
                            return L.hasClass(t)
                        })) && (t("tbody tr", this).removeClass(p.join(" ")), I.asDestroyStripes = p.slice()), p = [], 0 !== (C = this.getElementsByTagName("thead")).length && (W(I.aoHeader, C[0]), p = E(I)), null === g.aoColumns)
        ...
        iterator: function (t, e, n, r) {
            ...
            for ("string" == typeof t && (r = n, n = e, e = t, t = !1), i = 0, l = h.length; i < l; i++) {
                ...
                if ("table" === e) o = n.call(g, h[i], i), o !== a && d.push(o);
                    ...
                    for (f = this[i], "column-rows" === e && (c = Ce(h[i], p.opts)), s = 0, u = f.length; s < u; s++) o = f[s], o = "cell" === e ? n.call(g, h[i], o.row, o.column, i, s) : n.call(g, h[i], o, i, s, c), o !== a && d.push(o)
            }
    ...
    var De = function (e, n, r, o, i) {
        ...
        Ce = function (e, n) {
            ...
            else if ("current" == r || "applied" == r) i = "none" == s ? a.slice() : "applied" == s ? l.slice() : t.map(a, function (e) {
            ...
            if (n.length && t.length) {
                ...
                if (a._details) {
                    ...
                    o.off("draw.dt.DT_details column-visibility.dt.DT_details destroy.dt.DT_details"), 0 < re(i, "_details").length && (o.on("draw.dt.DT_details", function (t, e) {
                        ...
                        if (r === e)
                            for (var n = 0, a = i.length; n < a; n++) i[n]._details && Te(o, n)
                    }))
                }
            }
        };
